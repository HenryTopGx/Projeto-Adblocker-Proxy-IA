...
*/
    ...
    w.pa = w.noPatch === "on-demand";
    var fa;
    var ha = w.querySelectorImplementation;
    fa = ["native", "selectorEngine"].indexOf(ha) > -1 ? ha : void 0;
    ...
    function x(a) {
        return (a = v(a)) && a.firstChild !== void 0
    }
    function y(a) {
    ...
    function D() {
        ...
        for (var c = a.next(); !c.done; c = a.next())
            b.appendChild(za(c.value));
        return b
    }
    function Aa(a) {
        var b;
        for (b = b === void 0 ? 1 : b; b > 0; b--)
        ...
        for (var c = "", d = b ? b(a) : a.childNodes, e = 0, f = d.length, g = void 0; e < f && (g = d[e]); e++) {
            a: {
                ...
                case Node.ELEMENT_NODE:
                    l = h.localName;
                    for (var n = "<" + l, t = h.attributes, A = 0, ia; ia = t[A]; A++)
                        n += " " + ia.name + '="' + ia.value.replace(La, Na) + '"';
                    n += ">";
                    h = Pa[l] ? n : n + Ra(h, m) + "</" + l + ">";
                    break a;
                case Node.TEXT_NODE:
    ...
    function E(a, b) {
        ...
        for (var c = 0; c < b.length; c++) {
            ...
            e && (Object.defineProperty(a, "__shady_native_" + d, e),
            e.value ? Ta[d] || (Ta[d] = e.value) : Va(d))
        }
    }
    ...
    function ab() {
        ...
        window.EventTarget ? (E(window.EventTarget.prototype, a),
        window.__shady_native_addEventListener === void 0 && E(Window.prototype, a)) : (E(Node.prototype, a),
        E(Window.prototype, a),
        E(XMLHttpRequest.prototype, a));
        Sa ? E(Node.prototype, "parentNode firstChild lastChild previousSibling nextSibling childNodes parentElement textContent".split(" ")) : Wa(Node.prototype, {
            ...
            textContent: {
                ...
                set: function(b) {
                    ...
                    case Node.DOCUMENT_FRAGMENT_NODE:
                        Ya(this);
                        (b.length > 0 || this.nodeType === Node.ELEMENT_NODE) && this.__shady_native_insertBefore(document.createTextNode(b), void 0);
                        break;
                    default:
                        this.nodeValue = b
                    }
        ...
        Sa ? (E(Element.prototype, Za),
        E(Element.prototype, ["previousElementSibling", "nextElementSibling", "innerHTML", "className"]),
        E(HTMLElement.prototype, ["children", "innerHTML", "className"])) : (Wa(Element.prototype, a),
        Wa(Element.prototype, {
            ...
            innerHTML: {
                ...
                set: function(b) {
                    var c = this.localName === "template" ? this.content : this;
                    Ya(c);
        ...
        Sa ? (E(Document.prototype, Za),
        E(Document.prototype, ["activeElement"])) : Wa(Document.prototype, a);
    ...
    : function(a) {
        ...
        b.Ra || (b.Ra = !0,
        xa(a, bb),
        window.customElements && window.customElements.polyfillWrapFlushCallback && !w.noPatch || xa(a, cb))
    }
    ;
    ...
    function pb(a, b) {
        ...
        for (a = ob(a); d; )
            c.push(d),
            d = d.__shady_assignedSlot ? d.__shady_assignedSlot : d.nodeType === Node.DOCUMENT_FRAGMENT_NODE && d.host && (b || d !== a) ? d.host : d.__shady_parentNode;
    ...
    var sb = {
        get composed() {
            this.__composed === void 0 && (jb ? this.__composed = this.type === "focusin" || this.type === "focusout" || jb(this) : this.isTrusted !== !1 && (this.__composed = mb[this.type]));
    ...
    function xb(a, b, c) {
        if (c = b.__handlers && b.__handlers[a.type] && b.__handlers[a.type][c])
            for (var d = 0, e; (e = c[d]) && (!wb(a) || a.target !== a.relatedTarget) && (e.call(b, a),
            !a.__immediatePropagationStopped); d++)
                ;
    }
    ...
    function zb(a) {
        ...
        try {
            ...
            for (h = 0; h < b.length; h++) {
                ...
                var m = l === c[h];
                if (m || d)
                    if (f = m ? Event.AT_TARGET : Event.BUBBLING_PHASE,
                    xb(a, l, "bubble"),
                    a.fa)
                        break
            }
        } finally {
            yb || (e ? Object.defineProperty(a, "currentTarget", e) : delete a.currentTarget,
    ...
    function Bb(a) {
        Fa();
        return !w.R && this instanceof Node && !ra(document, this) ? (a.__target || Cb(a, this),
        zb(a)) : this.__shady_native_dispatchEvent(a)
    }
    function Db(a, b, c) {
        var d = this
          , e = lb(c)
        ...
        if (b) {
            var l = typeof b;
            if (l === "function" || l === "object")
                if (l !== "object" || b.handleEvent && typeof b.handleEvent === "function") {
                    if (nb[a])
                    ...
                    h = function(n) {
                        ...
                        if (!y(m) && m.localName !== "slot" || n.composedPath().indexOf(m) != -1)
                            if (n.composed || n.composedPath().indexOf(m) > -1)
                                if (wb(n) && n.target === n.relatedTarget)
                                    n.eventPhase === Event.BUBBLING_PHASE && n.stopImmediatePropagation();
                                else if (n.eventPhase === Event.CAPTURING_PHASE || n.bubbles || n.target === m || m instanceof Window) {
                                    var ia = l === "function" ? b.call(m, n) : b.handleEvent && b.handleEvent(n);
                                    m !== d && (t ? (Object.defineProperty(n, "currentTarget", t),
                                    t = null) : delete n.currentTarget,
                                    A ? (Object.defineProperty(n, "eventPhase", A),
                                    A = null) : delete n.eventPhase);
                                    return ia
                                }
                    }
                    ;
    ...
    function Eb(a, b, c) {
        if (b) {
            ...
            g && (f = Ab(g, f, a, c),
            f > -1 && (e = g.splice(f, 1)[0].cc,
            g.length || (b[ib] = void 0)));
            this.__shady_native_removeEventListener(a, e || b, d);
            e && this.__handlers && this.__handlers[a] && (a = this.__handlers[a][c ? "capture" : "bubble"],
            b = a.indexOf(e),
            b > -1 && a.splice(b, 1))
        }
    }
    ...
    function Pb(a, b, c, d) {
        ...
        if (b == a.length && d == c.length) {
            h = a.length;
            for (var m = c.length, n = 0; n < l - g && Qb(a[--h], c[--m]); )
                n++;
            h = n
        }
        e += g;
        ...
        for (a = []; l > 0 || g > 0; )
            ...
            m = b[l - 1][g],
            n = b[l][g - 1],
            t = m < n ? m < h ? m : h : n < h ? n : h,
            t == h ? (h == d ? a.push(0) : (a.push(1),
            d = h),
            l--,
            g--) : t == m ? (a.push(3),
            l--,
    ...
    function Tb(a, b, c) {
        var d = H();
        return d && b === "class" ? (d.setElementClass(a, c),
        !0) : !1
    }
    function Ub(a, b) {
        var c = H();
    ...
    function Xb(a, b) {
        if (a)
            for (a.nodeType === Node.ELEMENT_NODE && b(a),
            a = a.__shady_firstChild; a; a = a.__shady_nextSibling)
                a.nodeType === Node.ELEMENT_NODE && Xb(a, b)
    }
    ...
    var hc = C({
        get parentNode() {
            var a = v(this);
            a = a && a.parentNode;
            return a !== void 0 ? a : this.__shady_native_parentNode
        },
        get firstChild() {
            var a = v(this);
            a = a && a.firstChild;
            return a !== void 0 ? a : this.__shady_native_firstChild
        },
        get lastChild() {
            var a = v(this);
            a = a && a.lastChild;
            return a !== void 0 ? a : this.__shady_native_lastChild
        },
        get nextSibling() {
            var a = v(this);
            a = a && a.nextSibling;
            return a !== void 0 ? a : this.__shady_native_nextSibling
        },
        get previousSibling() {
            var a = v(this);
            a = a && a.previousSibling;
            return a !== void 0 ? a : this.__shady_native_previousSibling
        },
        get childNodes() {
            if (x(this)) {
                var a = v(this);
        ...
        get parentElement() {
            ...
            return a !== void 0 ? a : this.__shady_native_parentElement
        },
        get isConnected() {
            if (ac && ac.call(this))
                return !0;
            ...
            for (a = this; a && !(a instanceof Document); )
                a = a.__shady_parentNode || (y(a) ? a.host : void 0);
        ...
        set textContent(a) {
            ...
            case Node.DOCUMENT_FRAGMENT_NODE:
                if (!x(this) && w.j) {
                    ...
                    bc(this),
                    (a.length > 0 || this.nodeType === Node.ELEMENT_NODE) && this.__shady_insertBefore(document.createTextNode(a));
                break;
            default:
                this.nodeValue = a
            }
        ...
        insertBefore: function(a, b) {
            if (this.ownerDocument !== Yb && a.ownerDocument !== Yb)
                return this.__shady_native_insertBefore(a, b),
                a;
            if (a === this)
            ...
            if (b) {
                var c = v(b);
                c = c && c.parentNode;
                if (c !== void 0 && c !== this || c === void 0 && b.__shady_native_parentNode !== this)
            ...
            if (f) {
                var g = Wb(a);
                var h = !!c || !I(a) || Zb && this.__noInsertionPoint !== void 0;
                f.__shady_removeChild(a, h)
            }
            f = !0;
            var l = (!Zb || a.__noInsertionPoint === void 0 && this.__noInsertionPoint === void 0) && !Vb(a, e)
              , m = c && !a.__noInsertionPoint && (!Zb || a.nodeType === Node.DOCUMENT_FRAGMENT_NODE);
            if (m || l)
                l && (g = g || Wb(a)),
                Xb(a, function(n) {
                    m && n.localName === "slot" && d.push(n);
                    if (l) {
                        var t = g;
                        H() && (t && Ub(n, t),
                        (t = H()) && t.scopeNode(n, e))
            ...
            h = v(this),
            h.root ? (f = !1,
            la(this) && h.root.s()) : c && this.localName === "slot" && (f = !1,
            c.s()));
            f ? (c = y(this) ? this.host : this,
            b ? (b = dc(b),
            c.__shady_native_insertBefore(a, b)) : c.__shady_native_appendChild(a)) : a.ownerDocument !== this.ownerDocument && this.ownerDocument.adoptNode(a);
            return a
        },
        ...
        removeChild: function(a, b) {
            ...
            cc(a);
            c && ((b = this.localName === "slot") && (f = !0),
            (d || b) && c.s());
            f || (f = y(this) ? this.host : this,
            (!e.root && a.localName !== "slot" || f === a.__shady_native_parentNode) && f.__shady_native_removeChild(a));
            return a
        },
        ...
        cloneNode: function(a) {
            ...
            if (a && b.nodeType !== Node.ATTRIBUTE_NODE) {
                ...
                for (var c; a; a = a.__shady_nextSibling)
                    c = a.__shady_cloneNode(!0),
                    b.__shady_appendChild(c)
            }
            return b
        },
        getRootNode: function(a) {
            if (this && this.nodeType) {
                var b = u(this)
                  , c = b.ea;
                c === void 0 && (y(this) ? (c = this,
                b.ea = c) : (c = (c = this.__shady_parentNode) ? c.__shady_getRootNode(a) : this,
                document.documentElement.__shady_native_contains(this) && (b.ea = c)));
                return c
            }
        },
        contains: function(a) {
...
*/
    ...
    function kc(a, b, c, d) {
        for (d = d === void 0 ? !0 : d; b < a.length; b++)
            if (a[b] === "\\" && b < a.length - 1 && a[b + 1] !== "\n")
                b++;
            else {
                if (c.indexOf(a[b]) !== -1)
                    return b;
    ...
    function lc(a) {
        ...
        for (var c = [], d = [], e = 0; e < a.length; ) {
            ...
            if (h === ",")
                b();
            else if ([void 0, " ", ">", "+", "~"].indexOf(f) === -1 || h !== " ")
                f === " " && [">", "+", "~"].indexOf(h) !== -1 ? d[d.length - 1] = h : d.push(h);
            e = g + (g === e ? 1 : 0)
        }
        b();
        return c
    ...
    oc.replaceChildren = function() {
        for (var a = r.apply(0, arguments), b; (b = this.__shady_firstChild) !== null; )
            this.__shady_removeChild(b);
    ...
    function pc(a, b) {
        function c(e, f) {
            return (e === a || f.indexOf(":scope") === -1) && ma.call(e, f)
        }
        var d = lc(b);
        if (d.length < 1)
            return [];
        for (b = Aa(mc(a, function() {
            ...
            b = Aa(b.map(function(e) {
                ...
                if (l === ">")
                    return g = g.__shady_parentElement,
                    c(g, m) ? {
                        target: f,
                        N: h,
                        O: g,
                ...
                if (l === "+")
                    return (g = g.__shady_previousElementSibling) && c(g, m) ? {
                        target: f,
                        N: h,
                        O: g,
                        index: e
        ...
        querySelector: function(a) {
            if (K === "native") {
                ...
                for (var d = b.next(); !d.done; d = b.next())
                    if (d = d.value,
                    d.__shady_getRootNode() == c)
                        return d;
                return null
            }
            if (K === "selectorEngine")
                return pc(this, a)[0] || null;
            if (K === void 0)
...
*/
    var sc = C({
        ...
        before: function() {
            var a = this.__shady_parentNode;
            a !== null && a.__shady_insertBefore(D.apply(null, q(r.apply(0, arguments))), this)
        },
        remove: function() {
            var a = this.__shady_parentNode;
    ...
    function uc(a, b) {
        b === "slot" ? (a = a.__shady_parentNode,
        la(a) && v(a).root.s()) : a.localName === "slot" && b === "name" && (b = I(a)) && (b.Jb(a),
        b.s())
    }
    var vc = C({
        get previousElementSibling() {
            var a = v(this);
            if (a && a.previousSibling !== void 0) {
        ...
        setAttribute: function(a, b) {
            this.ownerDocument !== tc ? this.__shady_native_setAttribute(a, b) : Tb(this, a, b) || (this.__shady_native_setAttribute(a, b),
            uc(this, a))
        },
        removeAttribute: function(a) {
            this.ownerDocument !== tc ? this.__shady_native_removeAttribute(a) : Tb(this, a, "") ? this.getAttribute(a) === "" && this.__shady_native_removeAttribute(a) : (this.__shady_native_removeAttribute(a),
            uc(this, a))
        },
        toggleAttribute: function(a, b) {
            if (this.ownerDocument !== tc)
                return this.__shady_native_toggleAttribute(a, b);
            if (!Tb(this, a, ""))
                return b = this.__shady_native_toggleAttribute(a, b),
                uc(this, a),
                b;
    ...
    var Ac = document.implementation.createHTMLDocument("inert")
      , Bc = C({
        get innerHTML() {
            return x(this) ? Ra(this.localName === "template" ? this.content : this, va) : this.__shady_native_innerHTML
        },
        set innerHTML(a) {
            if (this.localName === "template")
                ...
                for (w.j ? b.__shady_native_innerHTML = a : b.innerHTML = a; a = b.__shady_firstChild; )
    ...
    var Dc = C({
        ...
        addEventListener: function(a, b, c) {
            if (this.localName !== "slot" || a === "slotchange")
                Db.call(this, a, b, c);
            else {
                typeof c !== "object" && (c = {
                    capture: !!c
    ...
    function Gc(a) {
        var b = new Set;
        for (b.add(a); y(a) && a.host; )
            a = a.host.__shady_getRootNode(),
            b.add(a);
        return b
    }
    var Hc = "__shady_native_" + ka()
      , Ic = C({
        ...
        elementsFromPoint: function(a, b) {
            a = document[Hc](a, b);
            if (this === document && w.useNativeDocumentEFP)
                return a;
            a = [].slice.call(a);
            b = Gc(this);
    ...
    var Jc = window.document
      , Kc = C({
        importNode: function(a, b) {
            if (a.ownerDocument !== Jc || a.localName === "template")
    ...
    function Nc(a) {
        var b = a ? null : Mc, c;
        for (c in M)
            N(window[c] && window[c].prototype, M[c], a, b)
    }
    ...
    function Rc(a, b) {
        if (Pc && !a.__shady_protoIsPatched && !y(a)) {
            ...
            d || (d = Object.create(c),
            Oc(d),
            c.__shady_patchedProto = d);
            Object.setPrototypeOf(a, d)
        }
        Qc || (b === 1 ? gb(a) : b === 2 && hb(a))
    }
    function Sc(a, b, c, d) {
        Rc(a, 1);
        d = d || null;
        ...
        if (f = v(e.previousSibling))
            f.nextSibling = a;
        if (f = v(e.nextSibling = d))
            f.previousSibling = a;
        e.parentNode = b;
        d ? d === c.firstChild && (c.firstChild = a) : (c.lastChild = a,
        c.firstChild || (c.firstChild = a));
        c.childNodes = null
    }
    function fc(a, b, c) {
        Rc(b, 2);
        var d = u(b);
        d.firstChild !== void 0 && (d.childNodes = null);
        if (a.nodeType === Node.DOCUMENT_FRAGMENT_NODE)
            for (a = a.__shady_native_firstChild; a; a = a.__shady_native_nextSibling)
                Sc(a, b, d, c);
        else
    ...
    function gc(a, b) {
        ...
        b.childNodes !== void 0 && (b.childNodes = null)
    }
    function wc(a, b) {
        var c = u(a);
        if (b || c.firstChild === void 0) {
            c.childNodes = null;
    ...
    function Uc(a, b) {
        ...
        B(a, Bc, b);
        B(a, J, b);
        w.noPatch && !b ? (B(a, hc, b),
        B(a, Ec, b)) : w.j || (B(a, db),
        B(a, bb),
        B(a, cb))
    }
    ;var yc = {}, O = w.deferConnectionCallbacks && document.readyState === "loading", Vc;
    function Wc(a) {
        var b = [];
        do
            b.unshift(a);
    ...
    k.ya = function(a, b) {
        ...
        a = u(this.host);
        a.root = this;
        a.Ub = this.mode !== "closed" ? this : null;
        a = u(this);
        a.firstChild = a.lastChild = a.parentNode = a.nextSibling = a.previousSibling = null;
        if (w.preferPerformance)
            for (; a = this.host.__shady_native_firstChild; )
                this.host.__shady_native_removeChild(a);
        else
            this.s()
    }
    ;
    ...
    k._renderSelf = function() {
        ...
        this.g && (this.ab(),
        this.Ya());
        if (!w.preferPerformance && !this.xa)
            for (var b = this.host.__shady_firstChild; b; b = b.__shady_nextSibling) {
                var c = v(b);
                b.__shady_native_parentNode !== this.host || b.localName !== "slot" && c.assignedSlot || this.host.__shady_native_removeChild(b)
            }
        this.xa = !0;
        O = a;
        Vc && Vc()
    ...
    k.ab = function() {
        ...
        for (var a = 0, b; a < this.g.length; a++)
            b = this.g[a],
            this.Xa(b);
        for (a = this.host.__shady_firstChild; a; a = a.__shady_nextSibling)
            this.ua(a);
        for (a = 0; a < this.g.length; a++) {
            b = this.g[a];
            var c = v(b);
            if (!c.assignedNodes.length)
                for (var d = b.__shady_firstChild; d; d = d.__shady_nextSibling)
                    this.ua(d, b);
    ...
    k.ua = function(a, b) {
        ...
        b ? (u(b).assignedNodes.push(a),
        c.assignedSlot = b) : c.assignedSlot = void 0;
    ...
    k.Ya = function() {
        for (var a = this.g, b = [], c = 0; c < a.length; c++) {
            var d = a[c].__shady_parentNode
              , e = v(d);
            e && e.root || !(b.indexOf(d) < 0) || b.push(d)
        }
        for (a = 0; a < b.length; a++)
            c = b[a],
            this.Ib(c === this ? this.host : c, this.Za(c))
    }
    ;
    k.Za = function(a) {
        var b = [];
        for (a = a.__shady_firstChild; a; a = a.__shady_nextSibling)
            if (this.nb(a))
                for (var c = v(a).K, d = 0; d < c.length; d++)
                    b.push(c[d]);
            else
                b.push(a);
        return b
    ...
    ;
    k.nb = function(a) {
        return a.localName == "slot"
    }
    ;
    k.Ib = function(a, b) {
        for (var c = ua(a), d = Pb(b, b.length, c, c.length), e = 0, f = 0, g = void 0; e < d.length && (g = d[e]); e++) {
            for (var h = 0, l = void 0; h < g.S.length && (l = g.S[h]); h++)
                l.__shady_native_parentNode === a && a.__shady_native_removeChild(l),
                c.splice(g.index + f, 1);
            f -= g.aa
        }
        e = 0;
        for (f = void 0; e < d.length && (f = d[e]); e++)
            for (g = c[f.index],
            h = f.index; h < f.index + f.aa; h++)
                l = b[h],
                a.__shady_native_insertBefore(l, g),
                c.splice(h, 0, l)
    }
    ;
    k.fb = function() {
    ...
    ;
    k.Z = function() {
        this.D && this.D.length && (this.qb(this.D),
        this.D = [])
    }
    ;
    k.qb = function(a) {
        for (var b, c = 0; c < a.length; c++) {
            ...
            this.i[e] ? (b = b || {},
            b[e] = !0,
            this.i[e].push(d)) : this.i[e] = [d];
            this.g.push(d)
        }
        if (b)
            for (var f in b)
                this.i[f] = this.Ea(this.i[f])
    }
    ;
    k.Aa = function(a) {
    ...
    k.Ea = function(a) {
        return a.sort(function(b, c) {
            ...
            for (var d = Wc(c), e = 0; e < b.length; e++) {
                ...
                var f = d[e];
                if (c !== f)
                    return b = va(c.__shady_parentNode),
            ...
            for (c in b)
                for (var d = b[c], e = 0; e < d.length; e++) {
                    ...
                    if (sa(a, f)) {
                        ...
                        g >= 0 && (this.g.splice(g, 1),
                        (g = v(f.__shady_parentNode)) && g.V && g.V--);
                        e--;
                        this.xb(f);
                        g = !0
                    }
    ...
    ca.Object.defineProperties(P.prototype, {
        activeElement: {
            ...
            enumerable: !0,
            get: function() {
                if (y(this.node) || this.node.nodeType === Node.DOCUMENT_NODE)
    ...
    ;if (w.inUse) {
        ...
        window.ShadyDOM = {
            ...
            wrapIfNeeded: w.noPatch === !0 ? cd : function(a) {
                return a
            }
            ,
            Wrapper: P,
        ...
        w.noPatch ? w.pa && B(Element.prototype, zc) : (Nc(),
        Kb());
        Fb();
        window.Event = Hb;
...
*/
    ...
    function id(a, b) {
        ...
        a.parent && (c = b.substring(a.previous ? a.previous.end : a.parent.start, a.start - 1),
        c = _expandUnicodeEscapes$$module$third_party$javascript$polymer$v2$shadycss$src$css_parse(c),
        c = c.replace(jd, " "),
        c = c.substring(c.lastIndexOf(";") + 1),
        c = a.parsedSelector = a.selector = c.trim(),
        a.atRule = c.indexOf("@") === 0,
        a.atRule ? c.indexOf("@media") === 0 ? a.type = 4 : c.match(kd) && (a.type = 7,
        a.keyframesName = a.selector.split(jd).pop()) : a.type = c.indexOf("--") === 0 ? 1E3 : 1);
        if (c = a.rules)
    ...
    function ld(a, b, c) {
        ...
        if (a.cssText || a.rules) {
            ...
            if (e && !_hasMixinRules$$module$third_party$javascript$polymer$v2$shadycss$src$css_parse(e))
                ...
                b ? b = a.cssText : (b = a.cssText,
                b = b.replace(md, "").replace(nd, ""),
                b = b.replace(od, "").replace(pd, "")),
                (d = b.trim()) && (d = "  " + d + "\n")
        }
    ...
    function _hasMixinRules$$module$third_party$javascript$polymer$v2$shadycss$src$css_parse(a) {
        a = a[0];
        return !!a && !!a.selector && a.selector.indexOf("--") === 0
    }
    var gd = /\/\*[^*]*\*+([^/*][^*]*\*+)*\//gim
      , hd = /@import[^;]*;/gim
      , md = /(?:^[^;\-\s}]+)?--[^;{}]*?:[^{};]*?(?:[;\n]|$)/gim
      ...
      , kd = /^@[^\s]*keyframes/
      , jd = /\s+/g;
    var Q = !(window.ShadyDOM && window.ShadyDOM.inUse), qd;
    function rd(a) {
    ...
    var sd;
    window.ShadyCSS && window.ShadyCSS.cssBuild !== void 0 && (sd = window.ShadyCSS.cssBuild);
    var R = !(!window.ShadyCSS || !window.ShadyCSS.disableRuntime);
    window.ShadyCSS && window.ShadyCSS.nativeCss !== void 0 ? qd = window.ShadyCSS.nativeCss : window.ShadyCSS ? (rd(window.ShadyCSS),
    window.ShadyCSS = void 0) : rd(window.WebComponents && window.WebComponents.flags);
    var S = qd;
    ...
    function Cd(a) {
        return !!a.parent && a.parent.type === 7
    }
    function Ad(a, b, c, d) {
        if (a) {
            var e = !1
            ...
            f === 1 ? b(a) : c && f === 7 ? c(a) : f === 1E3 && (e = !0);
            if ((a = a.rules) && !e)
                for (e = 0,
                f = a.length,
                g = void 0; e < f && (g = a[e]); e++)
                    Ad(g, b, c, d)
        }
    }
    function Dd(a, b, c, d) {
        ...
        e.textContent = a;
        if (window.enableHotReplacement && (a = document.head.querySelector("style[scope=" + b + "]")))
            return a.parentElement.replaceChild(e, a),
            e;
        Ed(e, c, d);
        return e
    }
    ...
    function V(a) {
        var b = a.localName
          , c = "";
        b ? b.indexOf("-") > -1 || (c = b,
        b = a.getAttribute && a.getAttribute("is") || "") : (b = a.is,
        c = a.extends);
        return {
            is: b,
            T: c
        ...
        if (a.__cssBuild === void 0) {
            ...
            if (b)
                ...
                a: {
                    ...
                    if (b instanceof Comment && (b = b.textContent.trim().split(":"),
                    b[0] === "css-build")) {
                        b = b[1];
                        break a
                    }
                ...
                if (b !== "") {
                    var c = a.localName === "template" ? a.content.firstChild : a.firstChild;
    ...
    function Md(a) {
        a = a === void 0 ? "" : a;
        return a !== "" && S ? Q ? a === "shadow" : a === "shady" : !1
    }
    ;function Nd(a, b) {
        var c = window.shadyCSSStyleTransformHooks;
        return c && (c = c.didTransformSelector,
        typeof c === "function") ? c(a, b) : a
    }
    function Od() {}
    function Pd(a, b) {
        var c = W;
    ...
    k.Y = function(a, b) {
        ...
        if (a = a.localName === "template" ? (a.content || a._content || a).childNodes : a.children || a.childNodes)
    ...
    k.element = function(a, b, c) {
        if (b)
            if (a.classList)
                c ? (a.classList.remove("style-scope"),
                a.classList.remove(b)) : (a.classList.add("style-scope"),
                a.classList.add(b));
            else if (a.getAttribute) {
                var d = a.getAttribute("class");
                c ? d && (b = d.replace("style-scope", "").replace(b, ""),
                Id(a, b)) : Id(a, (d ? d + " " : "") + "style-scope " + b)
            }
    }
    ;
    function Qd(a, b, c) {
    ...
    function Sd(a, b, c, d, e) {
        var f = W;
        e = e === void 0 ? "" : e;
        e === "" && (Q || (d === void 0 ? "" : d) === "shady" ? e = T(b, c) : (a = V(a),
        e = Td(f, b, a.is, a.T, c) + "\n\n"));
        return e.trim()
    }
    ...
    k.Ga = function(a, b, c, d) {
        ...
        if (!Cd(a)) {
            a = 0;
            for (var f = e.length, g = void 0; a < f && (g = e[a]); a++)
    ...
    k.Fb = function(a, b, c, d) {
        ...
        a.indexOf(":host") >= 0 ? a = this.Hb(a, d) : e !== 0 && (a = c ? this.Ha(a, c) : a);
        c = !1;
        e >= 0 && (b = "",
        c = !0);
        if (c) {
    ...
    function le(a, b, c) {
        b && (b = b.indexOf(";") >= 0 ? me(a, b, c) : Hd(b, function(d, e, f, g) {
            if (!e)
                return d + g;
            (e = le(a, c[e], c)) && e !== "initial" ? e === "apply-shim-inherit" && (e = "inherit") : e = le(a, c[f] || f, c) || f;
            return d + (e || "") + g
        }));
        return b && b.trim() || ""
    }
    ...
    function oe(a, b, c, d) {
        ...
        if (b.l.B) {
            ...
            var g = !!f.match(fe) || e === "html" && f.indexOf("html") > -1;
            var h = f.indexOf(":host") === 0 && !g;
            c === "shady" && (g = f === e + " > *." + e || f.indexOf("html") !== -1,
            h = !g && f.indexOf(e) === 0);
            if (g || h)
                c = e,
                h && (b.o || (b.o = W.Ga(b, W.la, W.ta(a), e)),
                c = b.o || e),
                g && e === "html" && (c = b.o || b.ec),
                d({
                    qa: c,
    ...
    he.prototype.Db = function(a, b, c, d) {
        a.o = a.o || a.selector;
        d = "." + d;
        for (var e = Kd(a.o), f = 0, g = e.length, h = void 0; f < g && (h = e[f]); f++)
    ...
    function re(a, b) {
        ...
        a.textContent = T(d, function(e) {
            ...
            e.l && e.l.cssText && (f = f.replace(md, "").replace(nd, ""),
            e.cssText = me(c, f, b))
        })
    }
            ...
            if (c.target !== document.documentElement && c.target !== document.head)
                for (var d = 0; d < c.addedNodes.length; d++) {
                    ...
                    if (e.nodeType === Node.ELEMENT_NODE) {
                        var f = e.getRootNode()
                          , g = ze(e);
                        if (g && f === e.ownerDocument && (e.localName !== "style" && e.localName !== "template" || Ld(e) === ""))
                            Rd(e, g);
                        else if (f instanceof ShadowRoot)
                            for (f = Ae(e),
                            f !== g && Qd(e, g, f),
                            e = window.ShadyDOM.nativeMethods.querySelectorAll.call(e, ":not(." + W.U + ")"),
                            g = 0; g < e.length; g++) {
                                f = e[g];
                                var h = Ae(f);
                                h && W.element(f, h)
    ...
    k.prepareTemplateStyles = function(a, b, c) {
        if (!a._prepared && !R) {
            ...
            S || (g = ie(a._styleAst));
            if (!g.length || S)
                b = this.jb(c, a._styleAst, Q ? a.content : null, te[b] || null, d, e ? f : ""),
                a._style = b;
            a.ub = g
        }
    }
    ...
    k.prepareTemplateDom = function(a, b) {
        if (!R) {
            var c = Ld(a);
            Q || c === "shady" || a._domPrepared || (a._domPrepared = !0,
            Pd(a.content, b))
        }
    }
    ;
    ...
    ;
    k.cb = function() {
        return !this.m && window.ShadyCSS && window.ShadyCSS.ApplyShim ? (this.m = window.ShadyCSS.ApplyShim,
        this.m.invalidCallback = He,
        !0) : !1
    }
    ;
    k.eb = function() {
        var a = this;
        !this.h && window.ShadyCSS && window.ShadyCSS.CustomStyleInterface && (this.h = window.ShadyCSS.CustomStyleInterface,
        this.h.transformCallback = function(b) {
            a.Na(b)
        }
        ,
    ...
    k.flushCustomStyles = function() {
        if (!R) {
            ...
            if (this.h) {
                ...
                !a && !this.h.enqueued || Md(this.A.cssBuild) || (S ? this.A.cssBuild || this.Bb(b) : (this.yb(b),
                this.ma(this.H, this.A),
                this.Ua(b),
                this.ha && this.styleDocument()),
                this.h.enqueued = !1)
            }
        }
    }
    ...
    k.styleElement = function(a, b) {
        ...
        } else if (c = X(a) || this.Ba(a))
            this.ia(a) || (this.ha = !0),
            b && this.za(c, b),
            S ? Me(this, a, c) : (this.flush(),
            this.ma(a, c),
            c.oa && c.oa.length && this.Va(a, c))
    }
    ;
    k.za = function(a, b) {
        a.L = a.L || {};
    ...
    function Me(a, b, c) {
        ...
        if (c.L) {
            var e = c.L, f;
            for (f in e)
                f === null ? b.style.removeProperty(f) : b.style.setProperty(f, e[f])
        }
        if (((e = Fe[d]) || a.ia(b)) && (!e || Ld(e) === "") && e && e._style && !Ie(e)) {
            if (Ie(e) || e._applyShimValidatingVersion !== e._applyShimNextVersion)
                a.M(),
                a.m && a.m.transformRules(e._styleAst, d),
                e._style.textContent = Sd(b, c.v),
                Je(e);
    ...
    k.Va = function(a, b) {
        ...
        var h = b.u;
        var l = se;
        g = e ? e.textContent || "" : qe(l, a, g, h);
        l = X(a);
        var m = l.J;
        m && !Q && m !== e && (m._useCount--,
        m._useCount <= 0 && m.parentNode && m.parentNode.removeChild(m));
        Q ? l.J ? (l.J.textContent = g,
        e = l.J) : g && (e = Dd(g, h, a.shadowRoot, l.placeholder)) : e ? e.parentNode || (ge && g.indexOf("@media") > -1 && (e.textContent = g),
        Ed(e, null, l.placeholder)) : g && (e = Dd(g, h, null, l.placeholder));
        e && (e._useCount = e._useCount || 0,
        l.J != e && e._useCount++,
        l.J = e);
        h = e;
        Q || (e = b.u,
        l = g = a.getAttribute("class") || "",
        f && (l = g.replace(new RegExp("\\s*x-scope\\s*" + f + "\\s*","g"), " ")),
        l += (l ? " " : "") + "x-scope " + e,
        g !== l && Id(a, l));
        d || Le.store(c, b.C, h, b.u);
        return h
    }
    ;
    k.ma = function(a, b) {
    ...
    k.Yb = function(a, b) {
        ...
        b = b ? (typeof b === "string" ? b : String(b)).split(/\s/) : [];
    ...
    var Z = new Y, Ne, Oe;
    window.ShadyCSS && (Ne = window.ShadyCSS.ApplyShim,
