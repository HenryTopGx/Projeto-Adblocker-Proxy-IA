    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 8,
                "vtp_includeConditions": ["list", "getbootstrap\\.com"],
                "tag_id": 19
            }, {
                ...
                "priority": 7,
                "vtp_instanceDestinationId": "G-W2VMDSX0CE",
                "tag_id": 31
            }, {
                ...
                "priority": 3,
                "vtp_conversionRules": ["list", ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"purchase\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"], ["map", "matchingRules", "{\"type\":5,\"args\":[{\"stringValue\":\"view_github_project\"},{\"contextValue\":{\"namespaceType\":1,\"keyParts\":[\"eventName\"]}}]}"]],
                "vtp_instanceDestinationId": "G-W2VMDSX0CE",
                "tag_id": 27
            }, {
                "function": "__ogt_event_create",
                "priority": 2,
                "vtp_eventName": "view_github_project",
                "vtp_isCopy": true,
                "vtp_instanceDestinationId": "G-W2VMDSX0CE",
                "vtp_precompiledRule": ["map", "new_event_name", "view_github_project", "merge_source_event_params", true, "event_name_predicate", ["map", "values", ["list", ["map", "type", "event_name"], ["map", "type", "const", "const_value", "page_view"]], "type", "eq"], "conditions", ["list", ["map", "predicates", ["list", ["map", "values", ["list", ["map", "type", "event_param", "event_param", ["map", "param_name", "page_path"]], ["map", "type", "const", "const_value", "\/twitter\/bootstrap\/"]], "type", "eqi"]]]], "event_param_ops", ["list", ["map", "edit_param", ["map", "param_name", "value", "param_value", ["map", "type", "const", "const_value", "0.0"]]]]],
                "tag_id": 26
            }, {
        ...
        ,
        "security_groups": {
            "google": ["__c", "__ccd_auto_redact", "__ccd_conversion_marking", "__ccd_ga_first", "__ccd_ga_last", "__ccd_ga_regscope", "__e", "__ogt_1p_data_v2", "__ogt_dma", "__ogt_event_create", "__ogt_ga_send", "__ogt_google_signals", "__ogt_referral_exclusion", "__ogt_session_timeout", "__set_product_settings"
            ]
...
*/
    ...
    li.je = Number("0") || 0;
    li.Za = "dataLayer";
    li.kn = "ChAI8IKQswYQ9sunlJ7ngukhEiUAJfvjjO9NSylzAa0+ajhFtjugkCK0hHiIQuGgsuiHstGaETD3GgKLzw\x3d\x3d";
    var ni = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    ;var Dj = {}
      ...
      , Mf = {
        ctid: "G-W2VMDSX0CE",
        canonicalContainerId: "126315764",
        Sj: "G-W2VMDSX0CE|GT-PBSXHXP",
        Tj: "G-W2VMDSX0CE"
    };
    Dj.fe = zb("");
    function Fj() {
    ...
    ;var tz = function(a, b) {
        for (var c = 0; c < a.length; ++c) {
            ...
            if (d)
                for (var e = 0; e < a[c].length; ++e)
                    a[c][e] && (a[c][e][Q.g.Yc] = d)
        }
    }
      , vz = function(a, b, c) {
        var d = uz[a.pa];
        d || (T(69) && a.t === "transaction" ? d = Q.g.Ja : a.promoa === "click" ? d = Q.g.Db : b.length ? d = Q.g.jb : c.length && (d = Q.g.ib));
        return d
    }
      , wz = function(a) {
        var b, c, d, e;
      ...
      , Ez = function(a, b, c, d, e) {
        ...
        if (!(!h || !m || g === void 0 || g < 0 || g >= 200)) {
            ...
            p && (m !== "impression" ? (p[g] || (p[g] = {}),
            p[g][h] || (p[g][h] = b)) : n !== void 0 && (p[n] || (p[n] = []),
            p[n][g] || (p[n][g] = {}),
            p[n][g][h] || (p[n][g][h] = b)))
        }
    }
      ...
      , Iz = /^(cd|cm)([1-9][0-9]{0,2})$/
      , Gz = /^cg([1-5])$/
      , xz = /^promo([1-9][0-9]{0,2})(id|cr|nm|ps)$/
      , zz = /^pr([0-9]{0,3})([a-z]{2}[0-9]{0,3})$/
      , Cz = /^il([0-9]{0,3})pi([0-9]{0,3})([a-z]{2}[0-9]{0,3})$/
      , Lz = /^il([1-9][0-9]{0,2})nm$/
      , Mz = function(a) {
        var b = Ij().filter(function(V) {
            return V.indexOf("G-") === 0
        });
        if (b.length) {
            var c = {}
              , d = function(V, ba) {
                ba !== void 0 && c[V] === void 0 && (c[V] = ba)
            }
              , e = {}
              , f = function(V, ba) {
                ba !== void 0 && e[V] === void 0 && (e[V] = ba)
            }
              , g = a.hitPayload;
            if (typeof g !== "string")
                P(126);
                ...
                var A = wz(h), D = A.Ml, E = A.Kl, C = A.Ll, F = A.Nl, M;
                if (h.pa || h.promoa || m.length || p.length || !D)
                    M = vz(h, m, p);
                M && h.tr && f(Q.g.qa, h.tr);
                var L;
                M === Q.g.Db || M === Q.g.jb ? L = m : M === Q.g.ib ? (tz(p, q),
                L = Array.prototype.concat.apply([], p)) : M && (L = n);
                L && L.length && f(Q.g.fa, L.filter(function(V) {
                    return !!V
                }));
                if (D || M) {
                    d(Q.g.Ck, E);
                    d(Q.g.Dk, C);
                    d(Q.g.qa, F);
                    d(Q.g.Ue, a.allowAdFeatures);
                    d(Q.g.oa, a.allowAdPersonalizationSignals);
                    d(Q.g.Ua, a.cookieDomain);
                    d(Q.g.Va, a.cookieExpires);
                    d(Q.g.cb, a.cookieFlags);
                    d(Q.g.Fb, a.cookiePath);
                    d(Q.g.Oa, a.cookieName === "_ga" ? void 0 : a.cookieName);
                    d(Q.g.vc, a.cookieUpdate);
                    d(Q.g.Xb, !0);
                    D && D !== M && $y(py(b, D, c));
                    var O = k(c);
                    k(e, O);
    ...
    var $A = function(a) {
        return a != null && a.length !== void 0 && qb(a.push)
    }
      , cB = function(a) {
        var b = aB.exec(a[0]);
        if (!b)
    ...
    function fF() {
        ...
        T(36) && eF ? a = eF : (a.set("containerId", 'G-W2VMDSX0CE'),
        a.set("version", '3'),
    ...
    function JH(a) {
        ...
        var e = {
          ...
          , f = b.o.eventId
          , g = py(b.target.ka, b.eventName, c);
        ry(g, f, e);
    }
