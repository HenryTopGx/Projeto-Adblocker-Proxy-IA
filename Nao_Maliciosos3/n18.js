 ...
 */
                function(e) {
                    var t, n, r, i, o, a, l, s, u, c, f, d, p, h, m, v, g, y, b, w = "sizzle" + 1 * new Date, x = e.document, k = 0, E = 0, _ = se(), S = se(), C = se(), T = se(), N = function(e, t) {
                        return e === t && (f = !0),
                        0
                    }, O = {}.hasOwnProperty, A = [], D = A.pop, P = A.push, j = A.push, L = A.slice, I = function(e, t) {
                    ...
                    }, K = /HTML$/i, X = /^(?:input|select|textarea|button)$/i, G = /^h\d$/i, J = /^[^{]+\{\s*\[native \w/, Z = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
                ...
                _.extend(_.event, {
                    trigger: function(e, t, n, i) {
                        ...
                        i || !f.trigger || !1 !== f.trigger.apply(n, t))) {
                            ...
                            return e.type = m,
                            i || e.isDefaultPrevented() || f._default && !1 !== f._default.apply(h.pop(), t) || !X(n) || u && g(n[m]) && !y(n) && ((l = n[u]) && (n[u] = null),
                            _.event.triggered = m,
                ...
                _.ajaxPrefilter("json jsonp", (function(e, t, n) {
                    var i, o, a, l = !1 !== e.jsonp && (Xt.test(e.url) ? "url" : "string" == typeof e.data && 0 === (e.contentType || "").indexOf("application/x-www-form-urlencoded") && Xt.test(e.data) && "data");
                    if (l || "jsonp" === e.dataTypes[0])
                        return i = e.jsonpCallback = g(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback,
                        l ? e[l] = e[l].replace(Xt, "$1" + i) : !1 !== e.jsonp && (e.url += (Tt.test(e.url) ? "&" : "?") + e.jsonp + "=" + i),
 ...
 */
            e = n.nmd(e),
            function() {
                var i, o = "Expected a function", a = "__lodash_hash_undefined__", l = "__lodash_placeholder__", s = 16, u = 32, c = 64, f = 128, d = 256, p = 1 / 0, h = 9007199254740991, m = NaN, v = 4294967295, g = [["ary", f], ["bind", 1], ["bindKey", 2], ["curry", 8], ["curryRight", s], ["flip", 512], ["partial", u], ["partialRight", c], ["rearg", d]], y = "[object Arguments]", b = "[object Array]", w = "[object Boolean]", x = "[object Date]", k = "[object Error]", E = "[object Function]", _ = "[object GeneratorFunction]", S = "[object Map]", C = "[object Number]", T = "[object Object]", N = "[object Promise]", O = "[object RegExp]", A = "[object Set]", D = "[object String]", P = "[object Symbol]", j = "[object WeakMap]", L = "[object ArrayBuffer]", I = "[object DataView]", R = "[object Float32Array]", M = "[object Float64Array]", $ = "[object Int8Array]", z = "[object Int16Array]", F = "[object Int32Array]", U = "[object Uint8Array]", W = "[object Uint8ClampedArray]", H = "[object Uint16Array]", B = "[object Uint32Array]", q = /\b__p \+= '';/g, V = /\b(__p \+=) '' \+/g, Y = /(__e\(.*?\)|\b__t\)) \+\n'';/g, Q = /&(?:amp|lt|gt|quot|#39);/g, K = /[&<>"']/g, X = RegExp(Q.source), G = RegExp(K.source), J = /<%-([\s\S]+?)%>/g, Z = /<%([\s\S]+?)%>/g, ee = /<%=([\s\S]+?)%>/g, te = /\.|\[(?:[^[\]]*|(["'])(?:(?!\1)[^\\]|\\.)*?\1)\]/, ne = /^\w*$/, re = /[^.[\]]+|\[(?:(-?\d+(?:\.\d+)?)|(["'])((?:(?!\2)[^\\]|\\.)*?)\2)\]|(?=(?:\.|\[\])(?:\.|\[\]|$))/g, ie = /[\\^$.*+?()[\]{}|]/g, oe = RegExp(ie.source), ae = /^\s+/, le = /\s/, se = /\{(?:\n\/\* \[wrapped with .+\] \*\/)?\n?/, ue = /\{\n\/\* \[wrapped with (.+)\] \*/, ce = /,? & /, fe = /[^\x00-\x2f\x3a-\x40\x5b-\x60\x7b-\x7f]+/g, de = /[()=,{}\[\]\/\s]/, pe = /\\(\\)?/g, he = /\$\{([^\\}]*(?:\\.[^\\}]*)*)\}/g, me = /\w*$/, ve = /^[-+]0x[0-9a-f]+$/i, ge = /^0b[01]+$/i, ye = /^\[object .+?Constructor\]$/, be = /^0o[0-7]+$/i, we = /^(?:0|[1-9]\d*)$/, xe = /[\xc0-\xd6\xd8-\xf6\xf8-\xff\u0100-\u017f]/g, ke = /($^)/, Ee = /['\n\r\u2028\u2029\\]/g, _e = "\\ud800-\\udfff", Se = "\\u0300-\\u036f\\ufe20-\\ufe2f\\u20d0-\\u20ff", Ce = "\\u2700-\\u27bf", Te = "a-z\\xdf-\\xf6\\xf8-\\xff", Ne = "A-Z\\xc0-\\xd6\\xd8-\\xde", Oe = "\\ufe0e\\ufe0f", Ae = "\\xac\\xb1\\xd7\\xf7\\x00-\\x2f\\x3a-\\x40\\x5b-\\x60\\x7b-\\xbf\\u2000-\\u206f \\t\\x0b\\f\\xa0\\ufeff\\n\\r\\u2028\\u2029\\u1680\\u180e\\u2000\\u2001\\u2002\\u2003\\u2004\\u2005\\u2006\\u2007\\u2008\\u2009\\u200a\\u202f\\u205f\\u3000", De = "['’]", Pe = "[" + _e + "]", je = "[" + Ae + "]", Le = "[" + Se + "]", Ie = "\\d+", Re = "[" + Ce + "]", Me = "[" + Te + "]", $e = "[^" + _e + Ae + Ie + Ce + Te + Ne + "]", ze = "\\ud83c[\\udffb-\\udfff]", Fe = "[^" + _e + "]", Ue = "(?:\\ud83c[\\udde6-\\uddff]){2}", We = "[\\ud800-\\udbff][\\udc00-\\udfff]", He = "[" + Ne + "]", Be = "\\u200d", qe = "(?:" + Me + "|" + $e + ")", Ve = "(?:" + He + "|" + $e + ")", Ye = "(?:['’](?:d|ll|m|re|s|t|ve))?", Qe = "(?:['’](?:D|LL|M|RE|S|T|VE))?", Ke = "(?:" + Le + "|" + ze + ")" + "?", Xe = "[" + Oe + "]?", Ge = Xe + Ke + ("(?:" + Be + "(?:" + [Fe, Ue, We].join("|") + ")" + Xe + Ke + ")*"), Je = "(?:" + [Re, Ue, We].join("|") + ")" + Ge, Ze = "(?:" + [Fe + Le + "?", Le, Ue, We, Pe].join("|") + ")", et = RegExp(De, "g"), tt = RegExp(Le, "g"), nt = RegExp(ze + "(?=" + ze + ")|" + Ze + Ge, "g"), rt = RegExp([He + "?" + Me + "+" + Ye + "(?=" + [je, He, "$"].join("|") + ")", Ve + "+" + Qe + "(?=" + [je, He + qe, "$"].join("|") + ")", He + "?" + qe + "+" + Ye, He + "+" + Qe, "\\d*(?:1ST|2ND|3RD|(?![123])\\dTH)(?=\\b|[a-z_])", "\\d*(?:1st|2nd|3rd|(?![123])\\dth)(?=\\b|[A-Z_])", Ie, Je].join("|"), "g"), it = RegExp("[" + Be + _e + Se + Oe + "]"), ot = /[a-z][A-Z]|[A-Z]{2}[a-z]|[0-9][a-zA-Z]|[a-zA-Z][0-9]|[^a-zA-Z0-9 ]/, at = ["Array", "Buffer", "DataView", "Date", "Error", "Float32Array", "Float64Array", "Function", "Int8Array", "Int16Array", "Int32Array", "Map", "Math", "Object", "Promise", "RegExp", "Set", "String", "Symbol", "TypeError", "Uint8Array", "Uint8ClampedArray", "Uint16Array", "Uint32Array", "WeakMap", "_", "clearTimeout", "isFinite", "parseInt", "setTimeout"], lt = -1, st = {};
                st[R] = st[M] = st[$] = st[z] = st[F] = st[U] = st[W] = st[H] = st[B] = !0,
                st[y] = st[b] = st[L] = st[w] = st[I] = st[x] = st[k] = st[E] = st[S] = st[C] = st[T] = st[O] = st[A] = st[D] = st[j] = !1;
                var ut = {};
                ut[y] = ut[b] = ut[L] = ut[I] = ut[w] = ut[x] = ut[R] = ut[M] = ut[$] = ut[z] = ut[F] = ut[S] = ut[C] = ut[T] = ut[O] = ut[A] = ut[D] = ut[P] = ut[U] = ut[W] = ut[H] = ut[B] = !0,
                ut[k] = ut[E] = ut[j] = !1;
                var ct = {
                    "\\": "\\",
                    "'": "'",
                ...
                var bn = function e(t) {
                    var n, r = (t = null == t ? mt : bn.defaults(mt.Object(), t, bn.pick(mt, at))).Array, le = t.Date, _e = t.Error, Se = t.Function, Ce = t.Math, Te = t.Object, Ne = t.RegExp, Oe = t.String, Ae = t.TypeError, De = r.prototype, Pe = Se.prototype, je = Te.prototype, Le = t["__core-js_shared__"], Ie = Pe.toString, Re = je.hasOwnProperty, Me = 0, $e = (n = /[^.]+$/.exec(Le && Le.keys && Le.keys.IE_PROTO || "")) ? "Symbol(src)_1." + n : "", ze = je.toString, Fe = Ie.call(Te), Ue = mt._, We = Ne("^" + Ie.call(Re).replace(ie, "\\$&").replace(/hasOwnProperty|(function).*?(?=\\\()| for .+?(?=\\\])/g, "$1.*?") + "$"), He = yt ? t.Buffer : i, Be = t.Symbol, qe = t.Uint8Array, Ve = He ? He.allocUnsafe : i, Ye = fn(Te.getPrototypeOf, Te), Qe = Te.create, Ke = je.propertyIsEnumerable, Xe = De.splice, Ge = Be ? Be.isConcatSpreadable : i, Je = Be ? Be.iterator : i, Ze = Be ? Be.toStringTag : i, nt = function() {
                        try {
                            var e = ho(Te, "defineProperty");
                            return e({}, "", {}),
                            e
                        } catch (e) {}
                    }(), it = t.clearTimeout !== mt.clearTimeout && t.clearTimeout, ct = le && le.now !== mt.Date.now && le.now, pt = t.setTimeout !== mt.setTimeout && t.setTimeout, ht = Ce.ceil, vt = Ce.floor, gt = Te.getOwnPropertySymbols, bt = He ? He.isBuffer : i, wt = t.isFinite, Ft = De.join, Qt = fn(Te.keys, Te), wn = Ce.max, xn = Ce.min, kn = le.now, En = t.parseInt, _n = Ce.random, Sn = De.reverse, Cn = ho(t, "DataView"), Tn = ho(t, "Map"), Nn = ho(t, "Promise"), On = ho(t, "Set"), An = ho(t, "WeakMap"), Dn = ho(Te, "create"), Pn = An && new An, jn = {}, Ln = Uo(Cn), In = Uo(Tn), Rn = Uo(Nn), Mn = Uo(On), $n = Uo(An), zn = Be ? Be.prototype : i, Fn = zn ? zn.valueOf : i, Un = zn ? zn.toString : i;
                    function Wn(e) {
                    ...
                    function Dr(e, t, n) {
                        for (var o = n ? Lt : jt, a = e[0].length, l = e.length, s = l, u = r(l), c = 1 / 0, f = []; s--; ) {
                            ...
                            s && t && (d = It(d, Zt(t))),
                            c = xn(d.length, c),
                            u[s] = !n && (t || a >= 120 && d.length >= 120) ? new Xn(s && d) : i
                        }
                        d = e[0];
                        var p = -1
                          , h = u[0];
                    ...
                    function Pr(e, t, n) {
                        var r = null == (e = Ao(e, t = xi(t, e))) ? e : e[Fo(Zo(t))];
                    ...
                    function Rr(e) {
                        return !(!rl(e) || (t = e,
                        $e && $e in t)) && (el(e) ? We : ye).test(Uo(e));
                        var t
                    }
                    function Mr(e) {
                        return "function" == typeof e ? e : null == e ? as : "object" == typeof e ? Ya(e) ? Hr(e[0], e[1]) : Wr(e) : ms(e)
                    }
                    function $r(e) {
                        if (!Co(e))
                            return Qt(e);
                    ...
                    function Hr(e, t) {
                        return Eo(e) && To(t) ? No(Fo(e), t) : function(n) {
                            var r = Ol(n, e);
                            return r === i && r === t ? Al(n, e) : Lr(t, r, 3)
                        }
                    }
                                ...
                                !function(e, t, n, r, o, a, l) {
                                    ...
                                    if (d) {
                                        var p = Ya(u)
                                          ...
                                          , m = !p && !h && dl(u);
                                        f = u,
                                        p || h || m ? Ya(s) ? f = s : Xa(s) ? f = Di(s) : h ? (d = !1,
                                        f = Si(u, !0)) : m ? (d = !1,
                    ...
                    function pi(e, t) {
                        return null == (e = Ao(e, t = xi(t, e))) || delete e[Fo(Zo(t))]
                    }
                    function hi(e, t, n, r) {
                    ...
                    function xi(e, t) {
                        return Ya(e) ? e : Eo(e, t) ? [e] : zo(xl(e))
                    }
                    var ki = Jr;
                    function Ei(e, t, n) {
                        var r = e.length;
                    ...
                    function $i(e) {
                        return function(t) {
                            return Mt(es(Vl(t).replace(et, "")), e, "")
                        }
                    }
                    function zi(e) {
                        return function() {
                    ...
                    function Wi(e, t, n, o, a, l, s, u, c, d) {
                        var p = t & f
                          , h = 1 & t
                          , m = 2 & t
                          , v = 24 & t
                        ...
                        return function i() {
                            ...
                            v && f < d) {
                                var E = dn(b, x);
                                return Ki(e, t, Wi, i.placeholder, n, b, E, u, c, d - f)
                            }
                            var _ = h ? n : this
                              , S = m ? _[e] : e;
                            return f = b.length,
                            ...
                            p && c < f && (b.length = c),
                            this && this !== mt && this instanceof i && (S = y || zi(S)),
                            S.apply(_, b)
                        }
                    }
                    function Hi(e, t) {
                    ...
                    var Gi = On && 1 / pn(new On([, -0]))[1] == p ? function(e) {
                        return new On(e)
                    }
                    : fs;
                    function Ji(e) {
                        return function(t) {
                            var n = go(t);
                            return n == S ? cn(t) : n == A ? hn(t) : function(e, t) {
                                return It(t, (function(t) {
                                    return [t, e[t]]
                                }
                                ))
                        ...
                        t && 1 != t)
                            E = 8 == t || t == s ? function(e, t, n) {
                                ...
                                return function a() {
                                    ...
                                    return (l -= f.length) < n ? Ki(e, t, Wi, a.placeholder, i, s, f, i, i, n - l) : Tt(this && this !== mt && this instanceof a ? o : e, this, s)
                                }
                            }(e, t, v) : t != u && 33 != t || p.length ? Wi.apply(i, k) : function(e, t, n, i) {
                                var o = 1 & t
                                  , a = zi(e);
                                return function t() {
                    ...
                    function uo(e) {
                        return (Re.call(Wn, "placeholder") ? Wn : e).placeholder
                    }
                    function co() {
                        var e = Wn.iteratee || ls;
                        return e = e === ls ? Mr : e,
                    ...
                    (Cn && go(new Cn(new ArrayBuffer(1))) != I || Tn && go(new Tn) != S || Nn && go(Nn.resolve()) != N || On && go(new On) != A || An && go(new An) != j) && (go = function(e) {
                        var t = Tr(e)
                    ...
                    var Ho = Jr((function(e, t) {
                        return Xa(e) ? pr(e, br(t, 1, Xa, !0)) : []
                    }
                    ))
                      , Bo = Jr((function(e, t) {
                        var n = Zo(t);
                        return Xa(n) && (n = i),
                        Xa(e) ? pr(e, br(t, 1, Xa, !0), co(n, 2)) : []
                    }
                    ))
                      , qo = Jr((function(e, t) {
                        var n = Zo(t);
                        return Xa(n) && (n = i),
                        Xa(e) ? pr(e, br(t, 1, Xa, !0), i, n) : []
                    }
                    ));
                    function Vo(e, t, n) {
                    ...
                    var ia = Jr((function(e) {
                        return di(br(e, 1, Xa, !0))
                    }
                    ))
                      , oa = Jr((function(e) {
                        var t = Zo(e);
                        return Xa(t) && (t = i),
                        di(br(e, 1, Xa, !0), co(t, 2))
                    }
                    ))
                      , aa = Jr((function(e) {
                        var t = Zo(e);
                    ...
                    var ba = Fi(Vo)
                      , wa = Fi(Yo);
                    function xa(e, t) {
                        return (Ya(e) ? Ot : hr)(e, co(t, 3))
                    }
                    function ka(e, t) {
                        return (Ya(e) ? At : mr)(e, co(t, 3))
                    }
                    ...
                    function Ma(e, t) {
                        ...
                        return n.cache = new (Ma.Cache || Kn),
                        n
                    }
                    function $a(e) {
                        if ("function" != typeof e)
                    ...
                    var Dl = Hi((function(e, t, n) {
                      ...
                      , jl = Jr(Pr);
                    function Ll(e) {
                        return Ka(e) ? Jn(e) : $r(e)
                    }
                    function Il(e) {
                        return Ka(e) ? Jn(e, !0) : zr(e)
                    }
                    var Rl = Li((function(e, t, n) {
                        Br(e, t, n)
                    }
                    ))
                      , Ml = Li((function(e, t, n, r) {
                        Br(e, t, n, r)
                    }
                    ))
                      , $l = io((function(e, t) {
                    ...
                    var Yl = $i((function(e, t, n) {
                      ...
                      , Kl = Mi("toLowerCase");
                    var Xl = $i((function(e, t, n) {
                        return e + (n ? "_" : "") + t.toLowerCase()
                    }
                    ));
                    var Gl = $i((function(e, t, n) {
                        return e + (n ? " " : "") + Zl(t)
                    }
                    ));
                    var Jl = $i((function(e, t, n) {
                    ...
                    ), 1), Cs = Xi("round"), Ts = Bi((function(e, t) {
                        return e - t
                    }
                    ), 0);
                    ...
                    Wn.toPath = function(e) {
                        return Ya(e) ? It(e, Fo) : fl(e) ? [e] : Di(zo(xl(e)))
                    }
                    ,
                    Wn.toPlainObject = wl,
                    Wn.transform = function(e, t, n) {
                        ...
                        return (i ? Ot : kr)(e, (function(e, r, i) {
                            return t(n, e, r, i)
                        }
                        )),
                        n
                    ...
                    Wn.escape = function(e) {
                        return (e = xl(e)) && G.test(e) ? e.replace(K, ln) : e
                    }
                    ,
                    ...
                    Wn.isEmpty = function(e) {
                        if (null == e)
                            return !0;
                        if (Ka(e) && (Ya(e) || "string" == typeof e || "function" == typeof e.splice || Ga(e) || dl(e) || Va(e)))
                            return !e.length;
                        var t = go(e);
                        if (t == S || t == A)
                            return !e.size;
                    ...
                    Wn.size = function(e) {
                        ...
                        var t = go(e);
                        return t == S || t == A ? e.size : $r(e).length
                    }
                    ,
                    Wn.snakeCase = Xl,
                    ...
                    Wn.unescape = function(e) {
                        return (e = xl(e)) && X.test(e) ? e.replace(Q, yn) : e
                    }
                    ,
 ...
 */
            ...
            function Er(e, t, n) {
                ...
                xr && dr(xr, r) || (xr = r,
                0 < (r = Mr(wr, "onSelect")).length && (t = new pn("onSelect","select",null,t,n),
                e.push({
                    event: t,
                    listeners: r
                }),
            ...
            function Ir(e, t, n, r, i) {
                ...
                !function(e, t, n) {
                    ...
                    if (0 == (7 & t)) {
                        ...
                        s ? (s = r,
                        null !== (u = (u = n.relatedTarget || n.toElement) ? ni(u) : null) && (u !== (f = Xe(u)) || 5 !== u.tag && 6 !== u.tag) && (u = null)) : (s = null,
                        u = r),
                        s !== u)) {
                            if (c = gn,
                            m = "onMouseLeave",
                        ...
                        qn = !0)),
                        0 < (g = Mr(r, b)).length && (b = new En(b,e,null,n,i),
                        a.push({
                            event: b,
                            listeners: g
                        }),
                        ...
                        (y = zn ? function(e, t) {
                            ...
                            if (qn)
                                return "compositionend" === e || !Mn && Hn(e, t) ? (e = rn(),
                                nn = tn = en = null,
                                qn = !1,
                                e) : null;
                            switch (e) {
                        ...
                        }(e, n)) && (0 < (r = Mr(r, "onBeforeInput")).length && (i = new En("onBeforeInput","beforeinput",null,n,i),
                        a.push({
                            event: i,
                            listeners: r
                        }),
            ...
            function Yo(e) {
                ...
                13 === e.tag) {
                    ...
                    Uo = Fo ? Qr(e.stateNode.nextSibling) : null;
                return !0
            }
            function Qo() {
                Uo = Fo = null,
            ...
            var Go = x.ReactCurrentDispatcher
            ...
            function la(e, t, n, r, i, o) {
                ...
                t.updateQueue = null,
                t.lanes = 0,
                Go.current = null === e || null === e.memoizedState ? ja : La,
                e = n(r, i),
                ia) {
                    o = 0;
                    do {
            ...
            function Va(e, t, n, r, i, o) {
                ...
                t.child = To(t, null, l, o)) : $a(e, t, l, o),
            ...
            function Ja(e, t, n) {
                var r, i = t.pendingProps, o = $o.current, a = !1;
            ...
            function ll(e, t, n) {
                    ...
                    null !== e && null != t.stateNode)
                        ...
                        Yo(t)) {
                            ...
                            l)
                                ...
                                "children" === u ? "string" == typeof o ? r.textContent !== o && (e = ["children", o]) : "number" == typeof o && r.textContent !== "" + o && (e = ["children", "" + o]) : s.hasOwnProperty(u) && null != o && "onScroll" === u && Ar("scroll", r));
                            switch (n) {
                            case "input":
                                X(r),
                                re(r, l, !0);
                            ...
                            for (l in c)
                                if (c.hasOwnProperty(l)) {
                                    var f = c[l];
                                    "style" === l ? ke(e, f) : "dangerouslySetInnerHTML" === l ? null != (f = f ? f.__html : void 0) && ge(e, f) : "children" === l ? "string" == typeof f ? ("textarea" !== n || "" !== f) && ye(e, f) : "number" == typeof f && ye(e, "" + f) : "suppressContentEditableWarning" !== l && "suppressHydrationWarning" !== l && "autoFocus" !== l && (s.hasOwnProperty(l) ? null != f && "onScroll" === l && Ar("scroll", e) : null != f && w(e, l, f, u))
                                }
                            switch (n) {
                            case "input":
                                X(e),
                ...
                case 13:
                    ...
                    r && !n && 0 != (2 & t.mode) && (null === e && !0 !== t.memoizedProps.unstable_avoidThisFallback || 0 != (1 & $o.current) ? 0 === $l && ($l = 3) : (0 !== $l && 3 !== $l || ($l = 4),
                    null === jl || 0 == (134217727 & Ul) && 0 == (134217727 & Wl) || ys(jl, Il))),
                    (r || n) && (t.flags |= 4),
                    null);
                case 4:
                    return Io(),
                    ...
                    for (f in r) {
                        ...
                        r.hasOwnProperty(f) && c !== u && (null != c || null != u))
                            if ("style" === f)
                                ...
                                u = u ? u.__html : void 0,
                                null != c && u !== c && (l = l || []).push(f, c)) : "children" === f ? "string" != typeof c && "number" != typeof c || (l = l || []).push(f, "" + c) : "suppressContentEditableWarning" !== f && "suppressHydrationWarning" !== f && (s.hasOwnProperty(f) ? (null != c && "onScroll" === f && Ar("scroll", e),
            ...
            function gl(e, t, n) {
                ...
                case 1:
                    ...
                    4 & n.flags && (null === t ? e.componentDidMount() : (r = n.elementType === n.type ? t.memoizedProps : Gi(n.type, t.memoizedProps),
            ...
            var Ql, Kl = null, Xl = !1, Gl = null, Jl = null, Zl = !1, es = null, ts = 90, ns = [], rs = [], is = null, os = 0, as = null, ls = -1, ss = 0, us = 0, cs = null, fs = !1;
            function ds() {
            ...
            function vs(e, t) {
                ...
                0 === r)
                    ...
                    null === zi ? (zi = [n],
                    Fi = Ci(Pi, Ki)) : zi.push(n),
                    n = Mi) : 14 === t ? n = Yi(99, bs.bind(null, e)) : (n = function(e) {
                        switch (e) {
                        case 15:
                        case 14:
                            return 99;
            ...
            function gs(e) {
                ...
                0 != (Fl & Wl))
                    ...
                    case 4:
                        ...
                        if (n = i,
                        10 < (n = (120 > (n = Hi() - n) ? 120 : 480 > n ? 480 : 1080 > n ? 1080 : 1920 > n ? 1920 : 3e3 > n ? 3e3 : 4320 > n ? 4320 : 1960 * Ol(n / 1960)) - n)) {
            ...
            function Us(e, t, n) {
                ...
                jl === e && (Il & n) === n && (4 === $l || 3 === $l && (62914560 & Il) === Il && 500 > Hi() - ql ? _s(e, 0) : Hl |= n),
                vs(e, t)
            }
            function Ws(e, t) {
                var n = e.stateNode;
            ...
            Ql = function(e, t, n) {
                        ...
                        if (0 == (n & r)) {
                            ...
                            case 13:
                                if (null !== t.memoizedState)
                                    return 0 != (n & t.child.childLanes) ? Ja(e, t, n) : (fi($o, 1 & $o.current),
                ...
                case 1:
                    return r = t.type,
                    i = t.pendingProps,
                    qa(e, t, r, i = t.elementType === r ? i : Gi(r, i), n);
                case 3:
                    if (Ya(t),
                    r = t.updateQueue,
                    null === e || null === r)
                    ...
                    (r = t.memoizedState.element) === i)
                        ...
                        if ((o = (i = t.stateNode).hydrate) && (Uo = Qr(t.stateNode.containerInfo.firstChild),
                        Fo = t,
                        o = Wo = !0),
                        o) {
                ...
                case 4:
                    ...
                    r = t.pendingProps,
                    null === e ? t.child = To(t, null, r, n) : $a(e, t, r, n),
                    t.child;
                case 11:
                    return r = t.type,
                    i = t.pendingProps,
                ...
                case 9:
                    ...
                    t.child;
                case 14:
                    return o = Gi(i = t.type, t.pendingProps),
                    Fa(e, t, i, o = Gi(i.type, o), r, n);
                case 15:
 ...
 */
    ...
    (()=>{
        ...
        function p() {
            ...
            f().remove("wt.mc_id");
            try {
                window.WcpConsent && WcpConsent.init("en-US", "cookie-banner", (function() {}
                ), d, WcpConsent.themes.light);
        ...
        function v() {
            ...
            function t(e, t, n) {
                ...
                function(e, t) {
                    ...
                    "appInsights"in window && "object" === m(window.appInsights) && "capturePageAction"in window.appInsights && "function" == typeof window.appInsights.capturePageAction && window.appInsights.capturePageAction(null, {
            ...
            var n = h("#download-matrix");
            h("#download-dropdown").on("click", (function(e) {
                "appInsights"in window && "object" === m(window.appInsights) && "capturePageAction"in window.appInsights && "function" == typeof window.appInsights.capturePageAction && window.appInsights.capturePageAction(null, {
                    behavior: "SHOW",
                    actionType: "CL",
                    contentTags: {
            ...
            if (r) {
                ...
                h("#confirmation #os-name-text").text(" for " + o[r].prettyOSName),
                h("#confirmation #direct-link").attr("href", o[r].link),
                setTimeout((function() {
        ...
        var C = ["JavaScript", "Python", "Java", "Markdown", "TypeScript", "C/C++", "JSON", "Powershell", "HTML/CSS", "C#", "PHP", "YAML"]
          , T = ["javascript", "python", "java", "markdown", "typescript", "cpp", "json", "powershell", "html", "csharp", "php", "yaml"];
        const N = function(e) {
            !function(e, t) {
            ...
            (n = [{
                key: "render",
                value: function() {
                    return g.createElement("div", null, C.map((function(e, t) {
                        var n = "assets/icons/file-icons/".concat(T[t], ".svg");
                        return g.createElement("div", {
                            className: "col-xs-6 col-sm-3 col-md-2"
                        }, g.createElement("p", null, g.createElement("img", {
        ...
        var O = n(570)
          ...
          , P = D({
            ...
            render: function() {
                return O.createElement("div", null, O.createElement("h3", {
                    className: "feedback-header"
                }, "Thank you!"), O.createElement("p", null, "We appreciate your feedback."))
            }
        })
          , j = D({
            ...
            render: function() {
                ...
                }, O.createElement("span"), O.createElement("span"), O.createElement("span"))
            }
        })
          , L = D({
            displayName: "Details",
            ...
            render: function() {
                var e;
                return this.props.isSending && (e = O.createElement(j, null)),
                O.createElement("form", {
                    ...
                    className: "feedback-header"
                }, "Additional feedback (".concat(this.calculateCharsLeft(), " characters left)"))), O.createElement("textarea", {
          ...
          , I = D({
            ...
            render: function() {
                return O.createElement("form", {
                    ...
                    className: "feedback-header"
                }, "435486d3-ad55-4a31-a087-d108f75ba669" == A('meta[name="ms.ContentId"]').attr("content") ? "Would you like to tell us why you want to uninstall Visual Studio Code?" : "Was this documentation helpful?"), O.createElement("br", null, null), O.createElement("button", {
                    onClick: this.props.handle,
                    value: 1
                }, "Yes", O.createElement("span", {
                    className: "sr-only"
                }, " , this page was helpful")), O.createElement("button", {
                    onClick: this.props.handle,
                    value: 0
                }, "No", O.createElement("span", {
                    className: "sr-only"
        ...
        const R = D({
            ...
            getInitialState: function() {
                return {
                    ...
                    vsFeedback: {
                        contentId: A('meta[name="ms.ContentId"]').attr("content")
                    }
                }
            },
            ...
            submitFeedback: function() {
                ...
                A.post("/docs/feedback", t).done((function() {
                    e.setState({
                        complete: !0
                    }),
                    A(".docs .feedback .widget").first().attr("role", "alert")
                }
                )).fail((function(e) {
            ...
            render: function() {
                var e;
                return e = this.state.complete ? O.createElement(P) : this.state.response ? O.createElement(L, {
        ...
        const re = new (function() {
            ...
            return q(e, [{
                key: "_get",
                value: function(e) {
                    var t = e ? $().concat(this.filters, e) : this.filters
                      , n = JSON.stringify({
                        filters: [{
                            criteria: t,
                ...
                value: function(e) {
                    return e ? (e = $().trim(e),
                    this._get(new ne(Q,e))) : this._get()
                }
            }, {
                key: "getByName",
                value: function(e) {
            ...
            e
        }())("https://marketplace.visualstudio.com/_apis/public/gallery/extensionquery",[new ne(Y,"Microsoft.VisualStudio.Code")],X | G | J | Z);
        function ie(e) {
          ...
          , le = F()({
            ...
            render: function() {
                var e = this.props.extension
                  , t = "Published by ".concat(e.publisher, ". ").concat(ie(e.installs), " installs.");
                return g.createElement("div", {
                    className: "cover",
                    id: "cover-" + e.id,
                    "aria-label": t
                    ...
                    className: "name",
                    title: e.displayName
                }, g.createElement("span", null, e.displayName)), g.createElement("div", {
                ...
                }, ie(e.installs))), g.createElement("div", {
                    className: "publisher"
                }, g.createElement("span", null, e.publisher)))))
            }
        })
          , se = F()({
            displayName: "Card",
        ...
        const ue = F()({
            ...
            render: function() {
                return 0 === this.state.extensions.length ? g.createElement("div", {
            ...
            setExtensionsOnState: function(e, t) {
                var n = $().map(e.results[0].extensions, (function(e) {
                    return new oe(e)
                }
                ));
                n = $().sortBy(n, "installs").reverse(),
                n = $().slice(n, 0, t),
                this.setState({
                    extensions: n
                })
            ...
            loadFromServer: function() {
                var e = this;
                return this.props.curated ? re.getByName(this.props.curated).then((function(t) {
                    e.setExtensionsOnState(t, e.props.curated.length)
                }
                )) : re.get(this.props.search).then((function(t) {
        ...
        const ge = function(e) {
            ...
            (n = [{
                ...
                value: function() {
                    ...
                    }), "Subscribe")), g.createElement("li", null, g.createElement("a", {
                    ...
                    }), "Ask questions")), g.createElement("li", null, g.createElement("a", {
                    ...
                    }), "Follow @code")), g.createElement("li", {
                    ...
                    }), "Request features")), g.createElement("li", {
                        id: "connect-github"
                    }, g.createElement("a", {
                    ...
                    }), "Report issues")), g.createElement("li", {
                        id: "connect-youtube"
                    }, g.createElement("a", {
        ...
        function Te(e, t) {
            if (t && ("object" === we(t) || "function" == typeof t))
                return t;
            if (void 0 !== t)
                throw new TypeError("Derived constructors may only return object or undefined");
            return function(e) {
        ...
        var De, Pe = {
            ...
            return Ee(n, [{
                ...
                value: function() {
                    return g.createElement("div", {
                    ...
                    }, g.createElement("caption", {
                        className: "sr-only"
                    }, "Linux VS Code Insiders downloads"), g.createElement("tbody", null, g.createElement("tr", null, g.createElement("td", null, g.createElement("strong", null, ".deb")), g.createElement("td", null, g.createElement("a", {
                    ...
                    }, "x64")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "linuxarmhf_deb"
                        }),
                    ...
                    }, "Arm32")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "linuxarm64_deb"
                        }),
                    ...
                    }, "Arm64"))), g.createElement("tr", null, g.createElement("td", null, g.createElement("strong", null, ".rpm")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "linux64_rpm"
                        }),
                    ...
                    }, "Arm64"))), g.createElement("tr", null, g.createElement("td", null, g.createElement("strong", null, ".tar.gz")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "linux64"
                        }),
                    ...
                    }, "Arm64"))), g.createElement("tr", null, g.createElement("td", null, g.createElement("strong", null, "Snap")), g.createElement("td", {
                        ...
                        id: "download-snap"
                    }, "Snap Store"))), g.createElement("tr", {
                        className: "cli-downloads"
                    }, g.createElement("td", null, g.createElement("strong", null, "CLI")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "linux64cli"
                        }),
            ...
            return Ee(n, [{
                ...
                value: function() {
                    return g.createElement("div", {
                        ...
                        className: "sr-only"
                    }, "Windows VS Code Insiders downloads"), g.createElement("tbody", null, g.createElement("tr", null, g.createElement("td", null, g.createElement("strong", null, "User Installer")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "win64user"
                        }),
                    ...
                    }, "Arm64"))), g.createElement("tr", null, g.createElement("td", null, g.createElement("strong", null, "System Installer")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "win64"
                        }),
                    ...
                    }, "Arm64"))), g.createElement("tr", null, g.createElement("td", null, g.createElement("strong", null, ".zip")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "winzip"
                        }),
            ...
            return Ee(n, [{
                ...
                value: function() {
                    return g.createElement("div", {
                        ...
                        className: "sr-only"
                    }, "Mac VS Code Insiders downloads"), g.createElement("tbody", null, g.createElement("tr", null, g.createElement("td", null, g.createElement("strong", null, ".zip")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "darwinx64"
                        }),
                    ...
                    }, "Intel chip")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
                            os: "darwinarm64"
                        }),
                    ...
                    }, "Apple silicon"))), g.createElement("tr", {
                        className: "cli-downloads"
                    }, g.createElement("td", null, g.createElement("strong", null, "CLI")), g.createElement("td", null, g.createElement("a", {
                        className: "dlink platform-link",
                        onClick: this.handleClick.bind(this, {
            ...
            return Ee(n, [{
                ...
                value: function() {
                    ...
                    return g.createElement("div", {
                        className: "alts"
                    }, g.createElement("p", null, "Also available on", " ", g.createElement("a", {
                        onClick: this.handleClick.bind(this, e.os),
                        href: "#".concat(e.os)
                    }, e.prettyName), ",", " ", g.createElement("a", {
                        onClick: this.handleClick.bind(this, t.os),
                        href: "#".concat(t.os)
                    }, t.prettyName), " ", "and", " ", g.createElement("a", {
            ...
            return Ee(n, [{
                ...
                value: function() {
                    return g.createElement("div", {
                    ...
                    }), ".deb", g.createElement("small", null, "Debian, Ubuntu")), g.createElement("button", {
                        style: Pe,
                        onClick: this.handleClick.bind(this, {
                            os: "linux64_rpm"
                        }),
                        ...
                        height: "18px",
                        alt: "Download VS Code"
                    }), ".rpm", g.createElement("small", null, "Red Hat, Fedora, SUSE")), g.createElement(je, {
                        build: this.props.build
                    }), this.props.showAlts && g.createElement(Re, {
                        alts: [Ae.win, Ae.osx]
                    }))
                }
            }]),
            n
        }(g.Component), $e = function(e) {
            _e(n, e);
            var t = Ce(n);
            function n() {
                return xe(this, n),
            ...
            return Ee(n, [{
                ...
                value: function() {
                    return g.createElement("div", {
                        ...
                        role: "link"
                    }, g.createElement("span", null, "Download Mac Universal"), g.createElement("small", null, "macOS 10.15+")), g.createElement(Ie, {
                        build: this.props.build
                    }), this.props.showAlts && g.createElement(Re, {
                        alts: [Ae.win, Ae.linux]
                    }))
                }
            }]),
            n
        }(g.Component), ze = function(e) {
            _e(n, e);
            var t = Ce(n);
            function n() {
                return xe(this, n),
            ...
            return Ee(n, [{
                ...
                value: function() {
                    return g.createElement("div", {
                        ...
                        role: "link"
                    }, g.createElement("span", null, "Download for Windows"), g.createElement("small", null, "Windows 10, 11")), g.createElement(Le, {
                        build: this.props.build
                    }), this.props.showAlts && g.createElement(Re, {
                        alts: [Ae.osx, Ae.linux]
                    }))
                }
            }]),
            n
        }(g.Component), Fe = function(e) {
            _e(n, e);
            var t = Ce(n);
            function n(e) {
                var r;
            ...
            return Ee(n, [{
                ...
                value: function() {
                    var e = this;
                    Oe.listen("oschange", (function(t) {
                        e.oschange(t.os)
                    }
                    )),
                    Oe.listen("download", (function(t) {
                        e.download(t)
                    }
                    ))
                }
        ...
        Fe.defaultProps = {
            os: (De = window.navigator.userAgent,
            De.includes("Mac") ? "osx" : De.includes("Linux") ? "linux" : De.includes("Win") ? "win" : "unknown"),
            build: "stable"
        };
        const Ue = Fe;
        function We(e) {
            ...
            (n = [{
                ...
                value: function() {
                    ...
                    if (this.state.products)
                        var t = g.createElement("div", null, g.createElement("table", {
                            className: "table table-striped",
                            style: this.tableStyle
                        }, g.createElement("tbody", null, this.state.products.map((function(e) {
                            return console.log(e),
                            g.createElement("tr", null, g.createElement("td", null, e.platform.prettyname), g.createElement("td", null, e.sha256hash))
                        }
                        )))));
                    return g.createElement("div", null, g.createElement("button", {
        ...
        n(180)((function() {
            ...
            function() {
                ...
                var a, l, s, u, c, f = navigator.userAgent, d = f.includes("Macintosh"), p = f.includes("Linux"), h = f.includes("Windows");
                function m() {
                ...
                i(".dynamic-keybinding").each((function() {
                    ...
                    var n = this.getAttribute("data-" + l)
                      , r = this.getAttribute("data-" + s);
                    n && r ? t = u + ": " + n + ", " + c + ": " + r : n ? t = u + ": " + n : r && (t = c + ": " + r),
            ...
            a.ajax({
                ...
                d.DataTable({
                    ...
                    createdRow: function(e, t) {
                        ...
                        t.lastUpdated == m && a("td:eq(2)", e).addClass("highlight"),
                        e
                    }
                }),
                h.hide(),
            ...
            l(".nav-search").on("submit", (function() {
                var e = l(this).find(".search-box").val().toString().trim();
            ...
            Xe(".sha-table-stable", g.createElement(Qe, {
                build: "stable"
            })),
            Xe(".sha-table-insider", g.createElement(Qe, {
                build: "insider"
            })),
            Xe(".download-btns.insiders-builds", g.createElement(Ue, {
                build: "insiders"
            })),
            Xe(".home-languages-list", g.createElement(N, null)),
            Xe(".feedback", g.createElement(R, null)),
            Xe(".connect-widget", g.createElement(ge, null), !0),
            Xe(".marketplace-extensions-top", g.createElement(ue, {
                curated: ["ms-python.python", "GitHub.copilot", "ms-vscode.cpptools", "vscjava.vscode-java-pack"]
            })),
            Xe(".marketplace-extensions-python", g.createElement(ue, {
                search: "python",
                display: 4
            })),
            Xe(".marketplace-extensions-debuggers", g.createElement(ue, {
                search: "category:debuggers",
                display: 4
            })),
            Xe(".marketplace-extensions-snippets", g.createElement(ue, {
                search: "category:snippets",
                display: 4
            })),
            Xe(".marketplace-extensions-languages", g.createElement(ue, {
                search: "category:languages",
                display: 4
            })),
            Xe(".marketplace-extensions-javascript", g.createElement(ue, {
                search: "javascript",
                display: 4
            })),
            Xe(".marketplace-extensions-javascript-linters", g.createElement(ue, {
                search: "category:linters javascript",
                display: 4
            })),
            Xe(".marketplace-extensions-php", g.createElement(ue, {
                search: "php",
                display: 4
            })),
            Xe(".marketplace-extensions-csharp", g.createElement(ue, {
                search: "c#",
                display: 4
            })),
            Xe(".marketplace-extensions-cpp", g.createElement(ue, {
                search: "c++",
                display: 4
            })),
            Xe(".marketplace-extensions-json", g.createElement(ue, {
                search: "json",
                display: 4
            })),
            Xe(".marketplace-extensions-html", g.createElement(ue, {
                search: "html",
                display: 4
            })),
            Xe(".marketplace-extensions-markdown", g.createElement(ue, {
                search: "markdown",
                display: 4
            })),
            Xe(".marketplace-extensions-typescript", g.createElement(ue, {
                search: "typescript",
                display: 4
            })),
            Xe(".marketplace-extensions-css", g.createElement(ue, {
                search: "css",
                display: 4
            })),
            Xe(".marketplace-extensions-docker", g.createElement(ue, {
                search: "docker",
                display: 4
            })),
            Xe(".marketplace-extensions-node", g.createElement(ue, {
                search: "node",
                display: 4
            })),
            Xe(".marketplace-extensions-refactor", g.createElement(ue, {
                search: "refactor",
                display: 4
            })),
            Xe(".marketplace-extensions-themes", g.createElement(ue, {
                search: "category:themes",
                display: 8
            })),
            Xe(".marketplace-extensions-multi-root-ready", g.createElement(ue, {
                search: 'tag:"multi-root ready"',
                display: 8
            })),
            Xe(".marketplace-popular-color-themes", g.createElement(ue, {
                curated: ["zhuangtongfa.Material-theme", "akamud.vscode-theme-onedark", "dracula-theme.theme-dracula", "azemoh.one-monokai"]
            })),
            Xe(".marketplace-popular-file-icon-themes", g.createElement(ue, {
            ...
            Xe(".marketplace-extensions-keymaps", g.createElement(ue, {
                search: "category:keymaps",
                display: 4
            })),
            Xe(".marketplace-extensions-curated-keymaps", g.createElement(ue, {
                curated: ["ms-vscode.sublime-keybindings", "vscodevim.vim", "ms-vscode.atom-keybindings", "ms-vscode.brackets-keybindings"]
            })),
            Xe(".marketplace-extensions-copilot", g.createElement(ue, {
                curated: ["GitHub.copilot"]
            })),
            Xe(".marketplace-extensions-languages-curated", g.createElement(ue, {
            ...
            Xe(".marketplace-extensions-azure-curated-short", g.createElement(ue, {
            ...
            Xe(".marketplace-extensions-angular-curated", g.createElement(ue, {
                curated: ["johnpapa.angular2", "Angular.ng-template", "Mikael.angular-beastcode", "johnpapa.angular-essentials"]
            })),
            Xe(".marketplace-extensions-node-curated", g.createElement(ue, {
            ...
            Xe(".marketplace-extensions-markdown-preview-curated", g.createElement(ue, {
                curated: ["bierner.markdown-preview-github-styles", "hbrok.markdown-preview-bitbucket", "goessner.mdmath", "bierner.markdown-emoji"]
            })),
            Xe(".marketplace-extensions-javascript-curated", g.createElement(ue, {
            ...
            Xe(".marketplace-extensions-javascript-linters-curated", g.createElement(ue, {
                curated: ["dbaeumer.vscode-eslint", "dbaeumer.jshint", "chenxsan.vscode-standardjs", "flowtype.flow-for-vscode"]
            })),
            Xe(".marketplace-extensions-learn-curated", g.createElement(ue, {
                curated: ["ms-python.python", "vscjava.vscode-java-pack", "ms-dotnettools.csharp", "ms-vscode.cpptools"]
            })),
            Xe("#marketplace-extensions-brackets", g.createElement(ue, {
                curated: ["ms-vscode.brackets-pack"]
            })),
            Xe(".marketplace-extensions-notebook-tools-curated", g.createElement(ue, {
            ...
            y = document.querySelectorAll(".hero-switcher-tabs button"),
            b = document.querySelectorAll(".hero-image"),
            y.length && b.length && (b.forEach((function(e) {
