(()=>{
        ...
        383: function(t) {
            t.exports = function() {
                ...
                return e.prototype.create = function() {
                    ...
                    this._openers = o('[data-a11y-dialog-show="' + this._id + '"]'),
                    this._openers.forEach(function(t) {
                    ...
                    )).concat(o('[data-a11y-dialog-hide="' + this._id + '"]')),
                    this._closers.forEach(function(t) {
                ...
                e.prototype.show = function(t) {
                    return this.shown || (document.documentElement.style.overflowY = "hidden",
                ...
                e.prototype.hide = function(t) {
                    return this.shown ? (document.documentElement.style.overflowY = "",
                    this.shown = !1,
                ...
                e.prototype.on = function(t, e) {
                    return void 0 === this._listeners[t] && (this._listeners[t] = []),
                ...
                e.prototype.off = function(t, e) {
                    ...
                    return o > -1 && this._listeners[t].splice(o, 1),
                    this
                }
                ,
                ...
                e.prototype._bindKeypress = function(e) {
                    ...
                    s && s.closest('[aria-modal="true"]') !== this.$el || (this.shown && "Escape" === e.key && "alertdialog" !== this.$el.getAttribute("role") && (e.preventDefault(),
                    this.hide(e)),
                    this.shown && "Tab" === e.key && function(e, s) {
                        var n = function(e) {
                        ...
                        s.shiftKey && 0 === a ? (n[n.length - 1].focus(),
                        s.preventDefault()) : s.shiftKey || a !== n.length - 1 || (n[0].focus(),
                        s.preventDefault())
                    }(this.$el, e))
                }
                ,
                ...
                ,
                "undefined" != typeof document && ("loading" === document.readyState ? document.addEventListener("DOMContentLoaded", n) : window.requestAnimationFrame ? window.requestAnimationFrame(n) : window.setTimeout(n, 16)),
                e
            }()
        }
    }, s = {};
    function n(t) {
        ...
        return o[t].call(a.exports, a, a.exports, n),
        a.exports
    }
    n.n = t=>{
    ...
    n.t = function(o, s) {
        ...
        if ("object" == typeof o && o) {
            if (4 & s && o.__esModule)
                return o;
            if (16 & s && "function" == typeof o.then)
                return o
        }
        ...
        var i = {};
        t = t || [null, e({}), e([]), e(e)];
        for (var c = 2 & s && o; "object" == typeof c && !~t.indexOf(c); c = e(c))
            Object.getOwnPropertyNames(c).forEach((t=>i[t] = ()=>o[t]));
        return i.default = ()=>o,
        n.d(a, i),
        a
    }
    ...
    (()=>{
        ...
        function s() {
            ...
            t.n && (document.querySelector("nav>button").addEventListener("click", (()=>{
                ...
                t.n.classList.contains("active") ? t.close() : t.open()
            }
            )),
            ...
            if (window.CSS && CSS.supports("color", "var(--bg)") && t) {
                ...
                for (var o = 0; o < t.length; o++)
                    t[o].onclick = function() {
                        var t = "light";
                        "light" === document.documentElement.getAttribute("data-theme") && (t = "dark"),
        ...
        function l() {
            ...
            t.listeners = function() {
                ...
                t.gt.onclick = function(e) {
                    e.preventDefault(),
                    (document.documentElement.scrollTop || document.body.scrollTop > 0) && t.scrollToTop()
                }
            }
            ,
            t.gt && t.listeners()
        ...
        class h {
            ...
            set(t, e) {
                this.data[t] = e,
                this.LS && (this.LS[this.name] = JSON.stringify(this.data))
            }
            get(t) {
        ...
        var b = "";
        y || (y = []);
        var k = document.getElementById("test_log")
          , _ = new function(t) {
            const e = this;
            e.snack = document.createElement("div"),
            e.snack.className = "snackbar",
            e.message = document.createElement("div"),
            e.snack.appendChild(e.message),
            document.body.appendChild(e.snack),
            e.top = t.topPos,
            e.classNames = t.classNames,
            e.autoClose = "boolean" == typeof t.autoClose && t.autoClose,
            e.autoCloseTimeout = t.autoClose && "number" == typeof t.autoCloseTimeout ? t.autoCloseTimeout : 3e3,
            e.reset = function() {
                e.message.innerHTML = "",
                e.snack.classList.remove(e.classNames)
            }
            ,
            e.show = function(t, o) {
                e.hide(),
                e.message.innerHTML = t,
                e.snack.style.top = e.top,
                e.snack.classList.add(o || e.classNames),
        ...
        async function x(t) {
            try {
                await navigator.clipboard.writeText(t).then((()=>{
                    _.show("URL copied to clipboard !")
                }
                ))
            } catch (e) {
        ...
        async function C(t, e, s, n, a) {
            ...
            e.appendChild(r);
            try {
                await fetch("https://" + t + "/fakepage.html", c, l, s, e).then((e=>{
                    console.log(e),
                    "basic" == e.type && 200 == e.status ? (r.innerHTML = o.v + "<span>" + t + "</span>",
                    M.blocked += 1,
                    Object.assign(M.hosts[n][a], {
                        [t]: !0
                    }),
                    b += "<br> " + t + " - blocked") : (s.style.background = "var(--red)",
                    r.innerHTML = o.x + "<span>" + t + "</span>",
                    M.notblocked += 1,
                    Object.assign(M.hosts[n][a], {
                        [t]: !1
                    }),
        ...
        function E(t, e) {
            document.querySelectorAll(".test_collapse").forEach((o=>{
                1 == t ? o.parentElement.classList.add("show") : o.parentElement.classList.remove("show"),
                1 == e && o.addEventListener("click", (()=>{
        ...
        const S = document.querySelector("#ctd_test");
        const z = document.querySelector(".lt_particles")
          , H = document.querySelector(".lt_cwrap");
        async function A() {
            document.querySelector(".lt_wrap").classList.add("start"),
            H.classList.add("start");
            let t = [];
            return 1 == f.showCF ? (M.total += 2,
            t.push(void setTimeout((function() {
                const t = document.querySelector("#cts_test");
                M.cosmetic_test.static = !t.clientHeight && !t.offsetHeight && "block" != window.getComputedStyle(t, null).getPropertyValue("display"),
                M.blocked += M.cosmetic_test.static ? 1 : 0,
                M.notblocked += M.cosmetic_test.static ? 0 : 1,
                document.querySelector("#ct_static").classList.add(M.cosmetic_test.static ? "_bg-green" : "_bg-red");
                let e = document.createElement("div");
                k.appendChild(e),
                e.innerHTML = " cosmetic_static_ad : " + M.cosmetic_test.static + "<br><br> ------------------------- ",
                T()
            }
            ), 500)),
            t.push(function() {
                ...
                e.id = "ad_ctd",
                e.className = "textads banner-ads banner_ads ad-unit afs_ads ad-zone ad-space adsbox",
                e.innerHTML = "&nbsp;",
                S.appendChild(e),
                setTimeout((function() {
                    let e = document.querySelector("#ad_ctd");
                    M.cosmetic_test.dynamic = !e.offsetHeight && !e.clientHeight && "block" != window.getComputedStyle(e, null).getPropertyValue("display"),
                    M.blocked += M.cosmetic_test.dynamic ? 1 : 0,
                    M.notblocked += M.cosmetic_test.dynamic ? 0 : 1,
                    k.appendChild(t),
                    t.innerHTML = " cosmetic_dynamic_ad : " + M.cosmetic_test.dynamic + "<br><br> ------------------------- ",
                    document.querySelector("#ct_dynamic").classList.add(M.cosmetic_test.dynamic ? "_bg-green" : "_bg-red"),
                    T()
                }
                ), 500)
            }())) : document.querySelector("#cf_wrap").style.display = "none",
            1 == f.showSL ? (M.total += 2,
            t.push(function() {
                let t = document.createElement("div");
                const e = document.querySelector("#sfa_1")
                  , o = document.querySelector("#sfa_2");
                M.script.ads = "undefined" == typeof s_test_ads,
                M.script.pagead = "undefined" == typeof s_test_pagead,
                M.script.partnerads = "undefined" == typeof s_test_partnerads,
                e.classList.add(M.script.ads ? "_bg-green" : "_bg-red"),
                o.classList.add(M.script.pagead ? "_bg-green" : "_bg-red"),
                M.blocked += (M.script.ads ? 1 : 0) + (M.script.pagead ? 1 : 0),
                M.notblocked += (M.script.ads ? 0 : 1) + (M.script.pagead ? 0 : 1),
                k.appendChild(t),
                t.innerHTML = "<div>script_ads : " + M.script.ads + "</div><div>script_pagead : " + M.script.pagead + "</div><br> ------------------------- ",
                T()
            ...
            t.push(async function() {
                ...
                return Object.keys(e).forEach((s=>{
                    if ("default" != s) {
                        ...
                        n.className = "grid",
                        n.id = s,
                        n.innerHTML = "<div><h5>" + o[s] + "&nbsp;&nbsp;" + s + "</h5><div>",
                        L.appendChild(n);
                        var a = e[s]
                          , i = 0;
                        M.hosts[s] = {};
                        ...
                        Object.keys(a).forEach((e=>{
                            ...
                            h.id = e,
                            h.style.background = "var(--green)";
                            let m = null != o[e] ? o[e] + "&nbsp" : "";
                            if (h.innerHTML = "<span class='test_collapse'>" + m + e + "</span>",
                            h.appendChild(u),
                            r % 2 == 0 ? l.appendChild(h) : c.appendChild(h),
                            r++,
                            Object.assign(M.hosts[s], {
                                [e]: {}
                            }),
                            Object.prototype.hasOwnProperty.call(a, e)) {
                                var p = a[e];
                                for (let o = 0; o < p.length; o++)
                                    t.push(C(p[o], u, h, s, e).then((()=>{
                                        T()
                                    }
                                    ))),
                                    d++
                            }
                            n.innerHTML = e + " => n° tests => " + d,
                            k.appendChild(n),
                            i += d
                        }
                        ));
                        var d = document.createElement("div");
                        d.innerHTML = s + " => Total n° tests => " + i + "<br> ------------------------- ",
                        k.appendChild(d)
                    }
                }
                )),
        ...
        function T() {
            var t = 100 / M.total * M.blocked
              , e = t > 30 ? t > 60 ? "var(--green)" : "var(--orange)" : "var(--red)";
            document.body.style.setProperty("--liquid-percentage", 45 - t + "%"),
            document.body.style.setProperty("--liquid-color", e),
            document.body.style.setProperty("--liquid-title", "'" + Math.round(t) + "%'")
        }
        function j() {
            !function(t, e) {
                t.style.opacity = 1,
                function o() {
                    (t.style.opacity -= .1) < 0 ? (t.style.display = "none",
        ...
        function O() {
            ...
            y.forEach(((e,s)=>{
                ...
                n.innerHTML = "<div class='card'><div>" + i + "<br><h6>" + e.date + '</h6></div><div><button class="btn-blue outline" data-r=' + e.time + ">" + o.download + "</button></div></div>",
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            for (const t in f)
                try {
                    ...
                    e.addEventListener("change", (()=>{
                        f[t] = e.checked,
                        console.log(t, e.checked),
                        "collapseAll" == t && E(f[t], !1),
                        w.set("settings", f)
                    }
                    ))
                } catch (t) {
            ...
            A().then((()=>{
                ...
                setTimeout((()=>{
                    ...
                    function() {
                        let t = Date.now();
                        var e = new Date(t);
                        let o = e.getDate() + "/" + (e.getMonth() + 1) + "/" + e.getFullYear() + " " + q(e.getHours()) + ":" + q(e.getMinutes()) + ":" + q(e.getSeconds());
                        y.length < 10 || y.splice(0, 1),
                        y.push({
                            time: t,
                            date: o,
                            note: "",
                    ...
                    b += "<br>-----<br> Total : " + M.total + "<br> Blocked : " + M.blocked + "<br> Not Blocked : " + M.notblocked,
                    t.innerHTML = b,
                    k.appendChild(t),
                    d(document.querySelector("#adb_test"), "flex");
                    document.querySelector("#adb_test_r").innerHTML = "<span>" + o.cdot + " Total : " + M.total + "</span><span>" + o.v + " " + M.blocked + " blocked</span><span>" + o.x + " " + M.notblocked + " not blocked </span>"
                }
                ), 2e3)
            }
            )),
            ...
            document.querySelector("#d3H_txt").addEventListener("click", (function() {
                x("https://raw.githubusercontent.com/d3ward/toolz/master/src/d3host.txt")
            }
            )),
            (t = "#d3H_adblock",
            document.querySelector(t)).addEventListener("click", (function() {
                x("https://raw.githubusercontent.com/d3ward/toolz/master/src/d3host.adblock")
            }
            ))
        }
        ))
