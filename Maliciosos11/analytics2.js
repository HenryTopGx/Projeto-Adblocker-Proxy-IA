    ...
    var data = {
        "resource": {
            ...
            "tags": [{
                ...
                "priority": 1,
                "vtp_instanceDestinationId": "UA-20899801-10",
                "tag_id": 9
            }, {
                "function": "__rep",
                "vtp_containerId": "UA-20899801-10",
                "vtp_remoteConfig": ["map"],
                "tag_id": 1
            }, {
                "function": "__zone",
                "vtp_childContainers": ["list", ["map", "publicId", "G-PLQS8CB04F"]],
...
*/
    ...
    li.je = Number("0") || 0;
    li.Za = "dataLayer";
    li.kn = "ChAI8MiaswYQgPGhxpKAspAaEicA6XNrf/zzBwdz3i+M3rorEKtMYcUtsNnkQ30iYovC73GMyQSKrdMaAoCZ";
    var ni = {
        __cl: 1,
        __ecl: 1,
        __ehl: 1,
    ...
    ;var Fl;
    try {
        Fl = JSON.parse(kb("eyIwIjoiQlIiLCIxIjoiQlItU1AiLCIyIjpmYWxzZSwiMyI6Imdvb2dsZS5jb20uYnIiLCI0IjoiIiwiNSI6ZmFsc2UsIjYiOmZhbHNlLCI3IjoiYWRfc3RvcmFnZXxhbmFseXRpY3Nfc3RvcmFnZXxhZF91c2VyX2RhdGF8YWRfcGVyc29uYWxpemF0aW9uIn0"))
    } catch (a) {
        P(123),
        El(2),
        Fl = {}
    ...
    ;var Sr = function(a, b) {
      ...
      , Ur = function(a, b, c) {
        ...
        G[a.functionName] = d;
        if (a.Ef)
            for (var e = 0; e < a.Ef.length; e++)
                G[a.Ef[e]] = G[a.Ef[e]] || Tr();
      ...
      , as = function(a, b, c, d, e) {
        ...
        if (b && c) {
            ...
            for (var f = {
                ...
                Sr(f.adData, d),
                Zr[h.id] = !0) : h && h.prefix === "UA" && !f.gaData && (f.gaData = {
                    gaWpid: h.ka
                },
                Zr[h.id] = !0))
            }
    ...
    ;function $z() {
        var a = [["cv", T(83) ? Zz() : "1"], ["rv", li.Og], ["tc", hf.filter(function(b) {
            return b
        }).length]];
    ...
    var kE = function(a, b) {
      ...
      , pE = function(a, b, c) {
        if (!c.isGtmEvent || !mE[a]) {
            var d = !X(Q.g.W)
              , e = function(f) {
                var g, h, m = tx(), n = nE(b, "", c), p, q = n.createOnlyFields._useUp;
                if (c.isGtmEvent || oE(b, n.createOnlyFields)) {
                    c.isGtmEvent && (g = "gtm" + Ci(),
                    ...
                    m(function() {
                        ...
                        n.fieldsToSet["&sst.gcut"] = gi[f]) : (n.fieldsToSend["&gcu"] = "1",
                        n.fieldsToSend["&sst.gcut"] = gi[f]),
                        t.set(n.fieldsToSet),
      ...
      , zE = function(a, b, c) {
        function d() {
            ...
            h(function() {
                if (!c.isGtmEvent && Ya(L)) {
                    var O = u.fieldsToSend, V = m().getByName(n), ba;
                    for (ba in L)
        ...
        var f = a, g, h = c.isGtmEvent ? ux(W(c, "gaFunctionName")) : ux();
        if (qb(h)) {
            var m = tx, n;
            ...
            var p = function(L) {
              ...
              , q = function(L) {
                var O = function(ka, ha) {
                    for (var ia = 0; ha && ia < ha.length; ia++)
                        p(ka, ha[ia])
                }
                  , V = c.isGtmEvent
                  , ba = V ? sE(u) : tE(b, c);
                if (ba) {
                    ...
                    R !== "promo_view" && R !== "impressions" && (O("ec:addProduct", ba.Kc),
                    p("ec:setAction", R, ba.vb))
                }
            }
              , r = function(L) {
                if (L) {
                    ...
                    if (Ya(L))
                        for (var V in uE)
                            uE.hasOwnProperty(V) && vE(uE[V], V, L[V], O);
                    qE(O, x);
                    p("require", "linkid", O)
                }
            }
            ...
            if (x) {
                var B = c.isGtmEvent ? u.fieldsToSet[Q.g.Ud] : u.createOnlyFields[Q.g.Ud];
                B && !wE[n] && (wE[n] = !0,
                h(xx(n, B)))
            }
            ...
            if (b === Q.g.Tb)
                if (c.isGtmEvent) {
                    ...
                    q(x);
                    p("send", "pageview");
                    u.createOnlyFields._useUp && vx(n + ".")
                } else
                    t(),
                ...
                pE(f, n, c)) : b === Q.g.Sa ? kE(n, c) : b === "screen_view" ? p("send", "screenview", u.fieldsToSend) : b === "timing_complete" ? (u.fieldsToSend.hitType = "timing",
                ...
                v("socialTarget", u.socialTarget, !0)) : ((c.isGtmEvent || xE[b]) && q(x),
                c.isGtmEvent && e(),
      ...
      , EE = !1;
    var yE, wE = {}, mE = {}, FE = {}, GE = Object.freeze((FE.page_hostname = 1,
    FE[Q.g.oa] = 1,
    FE[Q.g.lb] = 1,
    FE[Q.g.Ua] = 1,
    FE[Q.g.Va] = 1,
    ...
    FE[Q.g.Fa] = 1,
    FE[Q.g.Kb] = 1,
    FE)), HE = {}, hE = Object.freeze((HE.client_storage = "storage",
    HE.sample_rate = 1,
    HE.site_speed_sample_rate = 1,
    HE.store_gac = 1,
    ...
    HE[Q.g.Fb] = 1,
    HE[Q.g.vc] = 1,
    HE)), IE = {}, JE = Object.freeze((IE._cs = 1,
    IE._useUp = 1,
    IE.allowAnchor = 1,
    IE.allowLinker = 1,
    IE.alwaysSendReferrer = 1,
    IE.clientId = 1,
    IE.cookieDomain = 1,
    IE.cookieExpires = 1,
    IE.cookieFlags = 1,
    ...
    IE.cookiePath = 1,
    IE.cookieUpdate = 1,
    IE.legacyCookieDomain = 1,
    IE.legacyHistoryImport = 1,
    IE.name = 1,
    IE.sampleRate = 1,
    IE.siteSpeedSampleRate = 1,
    IE.storage = 1,
    IE.storeGac = 1,
    IE.useAmpClientId = 1,
    IE._cd2l = 1,
    IE)), KE = Object.freeze({
        anonymize_ip: 1
    }), LE = {}, iE = Object.freeze((LE.campaign = {
    ...
    LE.app_id = 1,
    LE.app_installer_id = 1,
    LE.app_name = 1,
    LE.app_version = 1,
    LE.description = "exDescription",
    LE.fatal = "exFatal",
    LE.language = 1,
    LE.page_hostname = "hostname",
    LE.transport_type = "transport",
    LE[Q.g.Ba] = "currencyCode",
    LE[Q.g.wg] = 1,
    LE[Q.g.ya] = "location",
    LE[Q.g.gd] = "page",
    LE[Q.g.Fa] = "referrer",
    ...
    LE[Q.g.ff] = 1,
    LE[Q.g.Da] = 1,
    LE)), ME = {}, NE = Object.freeze((ME.content_id = 1,
    ME.event_action = 1,
    ME.event_category = 1,
    ME.event_label = 1,
    ME.link_attribution = 1,
    ME.name = 1,
    ME[Q.g.xa] = 1,
    ME[Q.g.vg] = 1,
    ME[Q.g.Ka] = 1,
    ...
    ME)), OE = Object.freeze({
        ...
        timingVar: 1,
        value: 1
    }), BE = Object.freeze(["item_category", "item_category2", "item_category3", "item_category4", "item_category5"]), PE = {}, uE = Object.freeze((PE.levels = 1,
    PE[Q.g.Va] = "duration",
    PE[Q.g.uc] = 1,
    PE)), QE = {}, RE = Object.freeze((QE.anonymize_ip = 1,
    QE.fatal = 1,
    QE.send_page_view = 1,
    QE.store_gac = 1,
    ...
    }, SE = {}, xE = Object.freeze((SE.checkout_progress = 1,
    SE.select_content = 1,
    SE.set_checkout_option = 1,
    SE[Q.g.nc] = 1,
    SE[Q.g.oc] = 1,
    SE[Q.g.Sb] = 1,
    SE[Q.g.qc] = 1,
    ...
    SE[Q.g.rc] = 1,
    SE[Q.g.Na] = 1,
    SE)), TE = {}, UE = Object.freeze((TE.checkout_progress = 1,
    TE.set_checkout_option = 1,
    TE[Q.g.Wf] = 1,
    TE[Q.g.Xf] = 1,
    TE[Q.g.nc] = 1,
    TE[Q.g.oc] = 1,
    ...
    TE[Q.g.rc] = 1,
    TE[Q.g.Zf] = 1,
    TE)), VE = {}, WE = Object.freeze((VE.generate_lead = 1,
    VE.login = 1,
    VE.search = 1,
    VE.select_content = 1,
    VE.share = 1,
    VE.sign_up = 1,
    VE.view_search_results = 1,
    VE[Q.g.qc] = 1,
    VE[Q.g.ib] = 1,
    VE[Q.g.Db] = 1,
    VE[Q.g.jb] = 1,
    ...
    VE)), XE = function(a) {
        ...
        return b
    }, YE = {}, ZE = Object.freeze((YE.view_search_results = 1,
    YE[Q.g.ib] = 1,
    YE[Q.g.jb] = 1,
    YE[Q.g.Na] = 1,
    YE)), rE = function(a, b, c) {
        ...
        for (var r = !c.isGtmEvent, t = Om(c), u = 0; u < t.length; ++u) {
            ...
            if (c.isGtmEvent) {
                ...
                if (NE.hasOwnProperty(v))
                    vE(NE[v], v, y, e);
                else if (KE.hasOwnProperty(v))
                    vE(KE[v], v, y, g);
                else if (iE.hasOwnProperty(v))
                    vE(iE[v], v, y, f);
                else if (hE.hasOwnProperty(v))
                    vE(hE[v], v, y, h);
                    ...
                    var B = void 0
                      , A = void 0;
                    b === Q.g.da ? B = Mb(Pm(c, v), ".") : (B = Mb(Pm(c, v, 1), "."),
                    A = Mb(Pm(c, v, 2), "."));
                    B && (f["&gdid"] = B);
                    A && (f["&edid"] = A)
                } else
                    v === Q.g.Oa && t.indexOf(Q.g.uc) < 0 && (h.cookieName = y + "_ga");
                T(94) && GE[v] && (c.J.hasOwnProperty(v) || b === Q.g.da && c.m.hasOwnProperty(v)) && (r = !1)
            }
        }
        T(94) && r && (f["&jsscut"] = "1");
        d(Q.g.Ue) !== !1 && d(Q.g.lb) !== !1 && gE() || (g.allowAdFeatures = !1);
        ...
        if (c.isGtmEvent) {
            ...
            b === "login" || b === "sign_up" || b === "share" ? rE(e, "eventLabel", d(Q.g.vg)) : b === "search" || b === "view_search_results" ? rE(e, "eventLabel", d(Q.g.Vi)) : b === "select_content" && rE(e, "eventLabel", d(Q.g.Bi));
            var E = e[Q.g.xa] || {}
              , C = E[Q.g.Bc];
        ...
        fo() && (g["&gcs"] = go());
        g["&gcd"] = ko(c);
        $l() && (X(Q.g.W) || (h.storage = "none"),
        X([Q.g.R, Q.g.P]) || (g.allowAdFeatures = !1,
        h.storeGac = !1));
        no() && (g["&dma_cps"] = lo());
        g["&dma"] = mo();
        zn(Hn()) && (g["&tcfd"] = oo());
        ...
        if (b.promoClick) {
            ...
            c.Ne = b.translateIfKeyEquals === "promoClick" ? CE(f) : f;
        ...
        if (Ya(h))
            for (var m = 0; e && m < e.length; ++m) {
                var n = e[m], p;
                for (p in h)
                    h.hasOwnProperty(p) && /^(dimension|metric)\d+$/.test(p) && h[p] != void 0 && rE(n, p, n[h[p]])
            }
        var q = null
          , r = d(Q.g.Gi);
        if (a === Q.g.Ja || a === Q.g.rc)
            q = {
                action: a,
                vb: c(),
                Kc: CE(e)
        ...
        else if (a === "select_content" && r && r.length > 0 || a === Q.g.Db)
            q = {
                action: "promo_click",
                Ne: CE(r) || CE(e)
            };
        else if (a === "select_content" || a === Q.g.qc)
            q = {
                action: "click",
                vb: {
    ...
    Z.__rep = function(a) {
        var b = Xj(a.vtp_containerId), c = tm(b, !0), d;
        switch (c.prefix) {
        case "AW":
            d = CD;
            break;
        ...
        fn(b, d),
        a.vtp_remoteConfig && mn(b, a.vtp_remoteConfig || {})) : I(a.vtp_gtmOnFailure)
    }
    ,
    Z.__rep.D = "rep",
        ...
        var a = {}
          ...
          , c = function(d) {
            ...
            if (d.vtp_gtmTagId in a)
                hB(a[d.vtp_gtmTagId], d.vtp_gtmEventId, e);
            else if (e) {
                var f = d.vtp_childContainers.map(function(n) {
                  ...
                  , h = {};
                var m = jB(d.vtp_gtmEventId, f, g, h, Hw(1, d.vtp_gtmEntityIndex, d.vtp_gtmEntityName), !!d.vtp_inheritParentConfig);
                a[d.vtp_gtmTagId] = m
            }
