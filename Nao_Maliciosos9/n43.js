...
(function(f, h) {
    ...
    function u(a, b, c, e) {
        typeof a.addEventListener == "function" ? a.addEventListener(b, c, e || !1) : typeof a.attachEvent == "function" && a.attachEvent("on" + b, c)
    }
    function v(a, b, c, e) {
        typeof a.removeEventListener == "function" ? a.removeEventListener(b, c, e || !1) : typeof a.P == "function" && a.P("on" + b, c)
    }
    function m(a) {
        try {
    ...
    function r(a) {
        return (a = a.parentNode) && a.nodeType == 11 && a.host ? a.host : a
    }
    if ("IntersectionObserver"in f && "IntersectionObserverEntry"in f && "intersectionRatio"in f.IntersectionObserverEntry.prototype)
        ...
        d.prototype.J = function(a) {
            ...
            return a.sort().filter(function(b, c, e) {
                if (typeof b != "number" || isNaN(b) || b < 0 || b > 1)
        ...
        d.prototype.F = function(a, b) {
            if (f.getComputedStyle(a).display != "none") {
                var c = m(a);
                a = r(a);
                for (var e = !1; !e; ) {
                    var g = null
                      , k = a.nodeType == 1 ? f.getComputedStyle(a) : {};
                    if (k.display == "none")
                        return;
                    a == this.root || a == h ? (e = !0,
                    g = b) : a != h.body && a != h.documentElement && k.overflow != "visible" && (g = m(a));
                    if (g) {
        ...
        d.prototype.G = function(a) {
            var b = this.s.map(function(c, e) {
                return c.unit == "px" ? c.value : c.value * (e % 2 ? a.width : a.height) / 100
            });
            b = {
                top: a.top - b[0],
                right: a.right + b[1],
